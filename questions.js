window.QUESTION_BANK = [
  ...
  },
  {
    ...
    "multi": false,
    "explanation": "Identifying Fields should help Agentforce locate the right Knowledge article efficiently, so concise text or text area fields that summarize the article are the strongest fit. Long article bodies are better treated as content fields because they provide the detailed grounding material after the right article has been found. Option A is wrong because using the full main content as an identifying field can dilute search precision and make retrieval noisy. Option C is wrong because a formulabased concatenated key is usually optimized for system logic, not semantic article discovery. Salesforce's Knowledge grounding guidance distinguishes identifying fields, which help find relevant articles, from content fields, which provide the detailed information used in responses.",
    "section": "data"
  },
  {
    "id": 3,
    "text": "Universal Containers has configured an agent to handle customer return requests. When a customer initiates a return, the agent must calculate a specific restocking fee. The agent needs to quote this exact fee to the customer and then reuse that same fee amount when summarizing the final refund. The Agentforce Specialist needs to ensure the agent uses deterministic logic to calculate the fee and consistently reuses the exact same value without guessing or hallucinating. How should the specialist configure the agent to achieve this behavior?",
    "options": [
      {
        "letter": "A",
        "text": "Execute a flow as an agent action to calculate the fee, and make the flow's output directly available to the agent response. The agent will be able to continue to use this value from memory"
      },
      {
        "letter": "B",
        "text": "Define a context variable for the fee. Execute a flow as an agent action to calculate the fee, assign the flow's output to that context variable, and have the agent reference that variable in its responses"
      },
      {
        "letter": "C",
        "text": "Provide the mathematical formula for the restocking fee in the agent's system instructions and instruct it to remember the result for reuse"
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 4,
    "text": "Universal Containers (UC) wants to use Generative AI Salesforce functionality to reduce Service Agent handling time by providing recommended replies based on the existing Knowledge articles. On which AI capability should UC train the service agents?",
    "options": [
      {
        "letter": "A",
        "text": "Service Replies"
      },
      {
        "letter": "B",
        "text": "Case Replies"
  ...
  {
    "id": 5,
    "text": "Universal Containers (UC) is expanding its Agentforce for Service capabilities to include case management. For security purposes, UC wants the agent to verify a customer's identity before providing any case-related information. The verification must be deterministic-ensuring that no case details are shared unless identity verification has been successfully completed. Which approach best meets this requirement?",
    "options": [
      {
        "letter": "A",
        "text": "Use keywords such as \" Always \" and \" Never \" to write clear logic in Topic Instructions to verify user identity before providing any case information,"
      },
      {
        "letter": "B",
      ...
      {
        "letter": "C",
        "text": "Store the verification status in a custom variable and set a global instruction that the agent should check this variable before sharing case information."
      }
    ],
    "answer": [
      "B"
    ...
    "multi": false,
    "explanation": "The AgentForce for Service Implementation Guide clearly outlines that when an agent must verify identity before performing any case-related operations, the correct method is to use a variable-based control flow. The documentation specifies: \"To maintain deterministic and secure behavior, define a variable (for example, 'isVerified') that stores the result of an identity verification step. Use this variable as a conditional filter in the topic flow to ensure that case-related actions execute only when the variable equals 'true'.\" This ensures that no sensitive or case-specific data is shared unless verification is explicitly confirmed. It provides a deterministic safeguard, as the system only proceeds with case data actions after the verification variable confirms completion. Option A (\"Use keywords such as 'Always' and 'Never'\") relies on natural language instructions, which are not deterministic and can be misinterpreted by the model. Option C (\"Use a global instruction to check the variable\") adds unnecessary complexity and lacks the control-level filtering that ensures secure flow logic. Therefore, Option B correctly implements Salesforce's best-practice pattern for conditional execution using variables and filters in AgentForce.",
    "section": "agents"
  },
  {
    "id": 6,
    "text": "When using a prompt template, what should an Agentforce Specialist consider with their grounding data and chosen model?",
    "options": [
      {
        "letter": "A",
        "text": "Review the token limit in the Einstein Trust Layer."
      },
      {
        "letter": "B",
        "text": "Ensure queries used for grounding employ offset so the token limits of models are not exceeded."
      },
      {
        "letter": "C",
        "text": "Review the model limitation in Prompt Builder versus the grounding data size."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 9,
    "text": "What should Universal Containers consider when deploying an Agentforce Service Agent with multiple topics and Agent Actions to production?",
    "options": [
      {
        "letter": "A",
        "text": "Deploy agent components without a test run in staging, relying on production data for reliable results. Sandbox configuration alone ensures seamless production deployment."
      },
      {
        "letter": "B",
        "text": "Ensure all dependencies are included, Apex classes meet 75% test coverage, and configuration settings are aligned with production. Plan for version management and post-deployment activation."
      },
      {
        "letter": "C",
        "text": "Deploy flows or Apex after agents, topics, and Agent Actions to avoid deployment failures and potential production agent issues requiring complete redeployment."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 10,
    "text": "Universal Containers (UC) is looking to enhance its operational efficiency. UC has recently adopted Salesforce and is considering implementing Agent to improve its processes. What is a key reason for implementing Agent?",
    "options": [
      {
        "letter": "A",
        "text": "Improving data entry and data cleansing"
      },
      {
        "letter": "B",
        "text": "Allowing AI to perform tasks without user interaction"
      },
      {
        "letter": "C",
        "text": "Streamlining workflows and automating repetitive tasks"
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 11,
    "text": "Support agents at Universal Containers are using Agentforce to find troubleshooting information. They've reported that the agent frequently provides knowledge articles that are outdated, even when newer versions of the articles are available. The administrator has confirmed that all articles are correctly chunked and indexed. Which configuration change in the Data Cloud hybrid search index best addresses this problem?",
    "options": [
      {
        "letter": "A",
        "text": "Disable the keyword index to rely solely on the vector index."
      },
      {
        "letter": "B",
        "text": "Switch the chunking strategy from section-aware to fixed-size."
      },
      {
        "letter": "C",
        "text": "Add a ranking factor for regency based on the LastModifiedDate field."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 13,
    "text": "An Agentforce Specialist at Universal Containers observes that the agent frequently directs customers with clear billing inquiries to the general troubleshooting subagent. This misrouting is causing a spike in average handle time and missed service-level agreement targets. The contact center manager requires a solution that is quick to implement but preserves the agent's ability to handle complex, non-linear conversations. What is the most appropriate approach to resolve this?",
    "options": [
      {
        "letter": "A",
        "text": "Update the agent's global System Instructions to include a list of forbidden keywords for each subagent."
      },
      {
        "letter": "B",
        "text": "Audit subagent instructions for semantic competition and implement deterministic filters to guide the planner's selection."
      },
      {
        "letter": "C",
        "text": "Create a Router sub-flow that uses a Decision element to manually assign every incoming request to a specific subagent."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 14,
    "text": "Pacific Distribution Co. is implementing a system to manage partner order support and inventory inquiries. The company needs to ensure that large documents are processed effectively to improve retrieval accuracy when agents respond to partner queries. Understanding how documents are broken down and indexed is crucial for this implementation. What is a key characteristic of the chunking process?",
    "options": [
      {
        "letter": "A",
        "text": "Chunking breaks large documents into smaller units called passages."
      },
      {
        "letter": "B",
        "text": "The chunking process returns entire documents to the large language model for processing."
      },
      {
        "letter": "C",
        "text": "Chunking strategies are interchangeable and do not affect the retrieval process."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 16,
    "text": "An Al Specialist is tasked with creating a prompt template for a sales team. The template needs to generate a summary of all related opportunities for a given Account. Which grounding technique should the Al Specialist use to include data from the related list of opportunities in the prompt template?",
    "options": [
      {
        "letter": "A",
        "text": "Use the merge fields to reference a custom related list of opportunities."
      },
      {
        "letter": "B",
        "text": "Use merge fields to reference the default related list of opportunities."
      },
      {
        "letter": "C",
        "text": "Use formula fields to reference the Einstein related list of opportunities."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 18,
    "text": "What is automatically created when a custom search index is created in Data Cloud?",
    "options": [
      {
        "letter": "A",
        "text": "A retriever that shares the name of the custom search index."
      },
      {
        "letter": "B",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "B",
        "text": "Sales Agent to handle the upsell and large-deal escalation"
      },
      {
        "letter": "C",
        "text": "Employee Agent to orchestrate internal logistics and finance"
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 21,
    "text": "An Agentforce Service Agent, who has been successfully assisting customers with service requests in Salesforce, is now unable to help customers with issues related to a new product replacement process. The company recently implemented a custom Product Replacement object in Salesforce to track and manage these replacements. Which Agentforce Agent User change must be implemented to address this issue?",
    "options": [
      {
        "letter": "A",
        "text": "The permission set group assigned to the Agent User needs to grant access to the Product Replacement flow."
      },
      {
        "letter": "B",
        "text": "The permission set assigned to the Agent User needs Read access to the custom Product Replacement object."
      },
      {
        "letter": "C",
        "text": "The profile assigned to the Agentforce Agent User needs AI training permission to the custom Product Replacement object."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 22,
    "text": "An Al Specialist is tasked with configuring a generative model to create personalized sales emails using customer data stored in Salesforce. The AI Specialist has already fine-tuned a large language model (LLM) on the OpenAI platform. Security and data privacy are critical concerns for the client. How should the Agentforce Specialist integrate the custom LLM into Salesforce?",
    "options": [
      {
        "letter": "A",
        "text": "Create an application of the custom LLM and embed it in Sales Cloud via iFrame."
      },
      {
        "letter": "B",
        "text": "Add the fine-tuned LLM in Einstein Studio Model Builder."
      },
      {
        "letter": "C",
        "text": "Enable model endpoint on OpenAl and make callouts to the model to generate emails."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 23,
    "text": "Universal Containers' service team wants to customize the standard case summary response from Agentforce. What should the Agentforce Specialist do to achieve this?",
    "options": [
      {
        "letter": "A",
        "text": "Create a custom Record Summary prompt template for the Case object."
      },
      {
        "letter": "B",
        "text": "Summarize the Case with a standard Agent action."
      },
      {
        "letter": "C",
        "text": "Customize the standard Record Summary template for the Case object."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 24,
    "text": "An Agentforce Specialist deployed a Service Agent to an Experience Cloud site and enabled Credential-Based User Verification. The specialist notices that all Data Manipulation Language (DML) record updates are showing the \"Last Modified By\" user as the authenticated Community User instead of the Agent User. What should the specialist explain to the business about the effect on audit fields?",
    "options": [
      {
        "letter": "A",
        "text": "Credential-Based User Verification has been enabled, which in turn respects all sharing and field- level security."
      },
      {
        "letter": "B",
        "text": "The Flow execution mode for the agent is set to System Context Without Sharing."
      },
      {
        "letter": "C",
        "text": "Token-Based User Verification has been enabled, which in turn respects all sharing and field-level security."
      }
    ],
    "answer": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "Use the Model Context Protocol (MCP) to federate multiple external, thirdparty agents directly into the existing Agentforce Service console."
      },
      {
        "letter": "B",
        "text": "Implement a Multi-Org, Multi-Agent (MOMA) architecture connected via the Agent-to-Agent (A2A) protocol to safely isolate each department's agent."
      },
      {
        "letter": "C",
        "text": "Deploy a Single-Org, Multi-Agent (SOMA) architecture using a primary Orchestrator agent to manage shared context natively and route subtasks to the specialized agents."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 26,
    "text": "Universal Containers (UC) needs to save agents time with AI-generated case summaries. UC has implemented the Work Summary feature. What does Einstein consider when generating a summary?",
    "options": [
      {
        "letter": "A",
        "text": "Generation is grounded with conversation context, Knowledge articles, and cases."
      },
      {
        "letter": "B",
        "text": "Generation is grounded with existing conversation context only."
      },
      {
        "letter": "C",
        "text": "Generation is grounded with conversation context and Knowledge articles."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 27,
    "text": "A company's support agent is inconsistently executing a mandatory fraud check action before processing refunds. In some conversations the fraud check fires, but in others the agent skips directly to issuing the refund. Upon review, an Agentforce Specialist recommends placing the instruction guideline with run @actions.fraud_check followed by run @actions.process_refund. What is the effect of this configuration change?",
    "options": [
      {
        "letter": "A",
        "text": "The fraud-check action will be more strongly suggested to the large language model (LLM), but it may still be skipped if the LLM determines it is not relevant to the conversation."
      },
      {
        "letter": "B",
        "text": "The fraud-check action will execute after the large language model (LLM) check if it missed it in the process step execution, but the agent will lose its ability to use an empathetic tone."
      },
      {
        "letter": "C",
        "text": "The fraud-check action will be forced to execute before the refund action in every conversation, because procedural instructions provide deterministic control over the execution order."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 29,
    "text": "Universal Containers (UC) is deploying several prompt templates to assist its support agents using Salesforce' s standard foundation models. Leadership requires the generated responses to consistently reflect an empathetic and highly professional tone. UC only permits the use of standard foundational large language models (LLMs). What is the most effective prompt engineering technique the Agentforce Specialist should implement in Prompt Builder to fulfill this requirement?",
    "options": [
      {
        "letter": "A",
        "text": "Configure the prompt template tone with a dataset of past interactions using different writing styles, intensifiers, and punctuation to permanently alter the LLM default tone."
      },
      {
        "letter": "B",
        "text": "Include a direct instruction asking the LLM to role-play as a specific character, for example, \"Act as an empathetic customer support agent,\" to provide context and establish the tone."
      },
      {
        "letter": "C",
        "text": "Include multiple-choice picklist questions within the prompt template to systematically test and correct the LLM's understanding of the desired context before generating the output."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 30,
    "text": "Universal Containers deployed the new Agentforce Sales Development Representative (SDR) Into production, but sales reps are saying they can't find it. What is causing this issue?",
    "options": [
      {
        "letter": "A",
        "text": "Sales rep users profiles are missing the Allow SDR Agent permission."
      },
      {
        "letter": "B",
        "text": "Sales rep users do not have access to the SDR Agent object."
      },
      {
        "letter": "C",
        "text": "Sales rep users are missing the Use SDR Agent permission set."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 31,
    "text": "Universal Containers recently launched a pilot program to integrate conversational AI into its CRM business operations with Agentforce Agents. How should the Agentforce Specialist monitor Agents' usability and the assignment of actions?",
    "options": [
      {
        "letter": "A",
        "text": "Run a report on the Platform Debug Logs."
      },
      {
        "letter": "B",
        "text": "Query the Agent log data using the Metadata API."
      },
      {
        "letter": "C",
        "text": "Run Agent Analytics."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 32,
    "text": "What is the purpose of applying filters in a custom retriever configuration?",
    "options": [
      {
        "letter": "A",
      ...
      {
        "letter": "B",
        "text": "Filters automatically encrypt and mask sensitive fields in the search index to ensure that only non- confidential information is retrieved for public queries."
      },
      {
        "letter": "C",
        "text": "Filters reformat and aggregate multiple documents into a single summary output to streamline and unify retriever output for more efficient and accurate Al grounding."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 36,
    "text": "What is an Agentforce Specialist able to do when the 'Enrich event logs with conversation data' setting in the Agentforce configuration is enabled?",
    "options": [
      {
        "letter": "A",
        "text": "View the user click path that led to each agent action."
      },
      {
        "letter": "B",
        "text": "View session data including user input and agent responses for sessions."
      },
      {
        "letter": "C",
        "text": "Generate details reports on all agent conversations over any time period."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 37,
    "text": "At Horizon Insurance, the customer service team is reporting that the agent consistently routes claims intake conversations to the Policy Inquiry subagent, even though user intent clearly indicates a claims-related issue. This misrouting persists despite the user clearly expressing the intent to discuss a claim. The Agentforce Specialist added guard conditions, but the problem persists. What is most likely causing this incorrect routing in Horizon Insurance's agent?",
    "options": [
      {
        "letter": "A",
        "text": "Procedural instructions requiring Salesforce Flows to route to the correct subagent"
      },
      {
        "letter": "B",
        "text": "Use of global instructions to define subagent routing for agents in compliance-regulated environments"
      },
      {
        "letter": "C",
        "text": "Overlap in subagent descriptions and entry conditions between the Claims Intake and Policy Inquiry subagents"
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 39,
    "text": "Coral Cloud Resorts wants to cover a broad range of user phrasing when testing its FAQ agent. Which Testing Center feature meets that need?",
    "options": [
      {
        "letter": "A",
        "text": "Al-generated synthetic test utterances based on natural language variations"
      },
      {
        "letter": "B",
        "text": "Uploading only a small set of manually written prompts"
      },
      {
        "letter": "C",
        "text": "Relying on live customer logs to capture phrasing diversity after deployment"
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 40,
    "text": "Before activating a custom Agent action, an Agentforce Specialist would like to understand multiple real- world user utterances to ensure the action is being selected appropriately. Which tool should the Specialist recommend?",
    "options": [
      {
        "letter": "A",
        "text": "Agentforce"
    ...
    "multi": false,
    "explanation": "The Model Playground allows an Agentforce Specialist to test and simulate realworld user utterances against the configured actions, ensuring the custom Agent action is triggered appropriately based on intent matching and natural language understanding-without needing a full deployment.",
    "section": "testing"
  },
  {
    "id": 41,
    "text": "A support team handles a high volume of chat interactions and needs a solution to provide quick, relevant responses to customer inquiries. Responses must be grounded in the organization's knowledge base to maintain consistency and accuracy. Which feature in Einstein for Service should the support team use?",
    "options": [
      {
        "letter": "A",
        "text": "Einstein Service Replies"
      },
      {
        "letter": "B",
        "text": "Einstein Reply Recommendations"
      },
      {
        "letter": "C",
        "text": "Einstein Knowledge Recommendations"
      }
    ],
    "answer": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "Select the appropriate prompt template type to use, select one of Salesforce's standard prompts, determine the object to associate the prompt, select a record to validate against, and associate the prompt to an action."
      },
      {
        "letter": "B",
        "text": "Select the appropriate prompt template type to use, develop the prompt within the prompt workspace, select resources to dynamically insert CRMderived grounding data, pick the model to use, and test and validate the generated responses."
      },
      {
        "letter": "C",
        "text": "Enable the target object for generative prompting, develop the prompt within the prompt workspace, select records to fine-tune and ground the response, enable the Trust Layer, and associate the prompt to an action."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 46,
    "text": "Coral Cloud Resorts (CCR) wants to configure its agent so that booking actions are only available when a customer's membership tier is \"Premium\" or \"Elite\". This business rule must be enforced deterministically. What should CCR implement?",
    "options": [
      {
        "letter": "A",
        "text": "Set up custom validation rules on the underlying booking objects to prevent non-eligible customers from completing bookings."
      },
      {
        "letter": "B",
        "text": "Configure topic instructions that clearly state booking actions should only be used for Premium or Elite customers and include examples."
      },
      {
        "letter": "C",
        "text": "Create a context variable mapped to the customer's membership tier field, then add a conditional filter on MembershipTier."
      }
    ],
    "answer": [
      "C"
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "Response accuracy and offensiveness score"
      },
      {
        "letter": "B",
        "text": "Hallucination score and bias score"
      },
      {
        "letter": "C",
        "text": "Masked data and toxicity score"
      }
    ],
    "answer": [
      "C"
    ...
    "multi": false,
    "explanation": "Universal Containers is considering the use of the Einstein Trust Layer along with Einstein Generative AI Audit Data. The Einstein Trust Layer provides a secure and compliant way to use AI by offering features like data masking and toxicity assessment. The audit data available through the Einstein Trust Layer includes information about masked data- which ensures sensitive information is not exposedand the toxicity score, which evaluates the generated content for inappropriate or harmful language.",
    "section": "prompt"
  },
  {
    "id": 49,
    "text": "Before activating a custom copilot action, An Agentforce would like is to understand multiple real-world user utterances to ensure the action being selected appropriately. Which tool should the Agentforce Specialist recommend?",
    "options": [
      {
        "letter": "A",
        "text": "Model Playground"
  ...
  {
    "id": 51,
    "text": "Universal Containers (UC) needs to create a prompt template that provides a detailed product description based on the latest product data. The description will be used in marketing materials to ensure consistency and accuracy. Which prompt template type should UC use?",
    "options": [
      {
        "letter": "A",
        "text": "Record Summary"
  ...
  {
    "id": 52,
    "text": "Cloud Kicks is developing a prompt template in a sandbox and has created multiple saved versions during testing. Cloud Kicks is now preparing to move the template to production. What is a consideration when deploying the template to production?",
    "options": [
      {
        "letter": "A",
        "text": "Deploying a template requires all previous versions to be manually activated before deployment can succeed"
      },
      {
        "letter": "B",
        "text": "Deploying a template automatically removes all prior versions and replaces them with the deployed version in production"
      },
      {
        "letter": "C",
        "text": "Deploying a prompt template includes all versions of the prompt template that are in the source org to the target org"
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 53,
    "text": "An Agentforce Agent has been developed with multiple topics and Agent Actions that use flows and Apex. Which options are available for deploying these to production?",
    "options": [
      {
        "letter": "A",
        "text": "Deploy the flows and Apex using normal deployment tools and manually create the agent-related items in production."
      },
      {
        "letter": "B",
        "text": "Use only change sets because the Salesforce CLI does not currently support the deployment of agent- related metadata."
      },
      {
        "letter": "C",
        "text": "Deploy flows, Apex, and all agent-related items using either change sets or the Salesforce CLI /Metadata API."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 55,
    "text": "An Agentforce wants to include data from the response of external service invocation (REST API callout) into the prompt template. How should the Agentforce Specialist meet this requirement?",
    "options": [
      {
        "letter": "A",
        "text": "Convert the JSON to an XML merge field."
      },
      {
        "letter": "B",
        "text": "Use External Service Record merge fields."
      },
      {
        "letter": "C",
        "text": "Use \"Add Prompt Instructions\" flow element."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 56,
    "text": "How is Data Cloud leveraged by the Answer Questions with Knowledge action in Agentforce?",
    "options": [
      {
        "letter": "A",
        "text": "Data Cloud is not required; the articles can be accessed directly from the CRM by the agent."
      },
      {
        "letter": "B",
        "text": "Data Cloud stores and manages the Indexed Knowledge articles."
      },
      {
        "letter": "C",
        "text": "Data Cloud provides the real-time data streams that update the Knowledge articles."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 57,
    "text": "Cloud Kicks (CK) recently finished the development of a new prompt template that uses its own large language model (LLM). CK is deploying a prompt template from a sandbox to a production org, and is receiving an error. When trying to deploy the change set, CK is getting an error related to the LLM used in the prompt template. What is the cause of the error?",
    "options": [
      {
        "letter": "A",
        "text": "The prompt does not specify that it is a custom LLM."
      },
      {
        "letter": "B",
        "text": "BYOLLM is not yet supported for in prompt templates in production."
      },
      {
        "letter": "C",
        "text": "The name of the LLM does not match in sandbox and production."
      }
    ],
    "answer": [
      "C"
    ...
    "multi": false,
    "explanation": "As documented in the AgentForce Prompt Template and BYOLLM (Bring-Your- Own-LLM) Deployment Guide, each prompt template references a specific LLM configuration by name and ID. When migrating components between environments (e.g., from sandbox to production), the referenced LLM must also exist in the target org with the exact same name and identifier. If the LLM configuration is missing or named differently in production, the deployment fails, as the prompt template cannot resolve its model dependency. Option A is incorrect because specifying a custom LLM type does not resolve the missing configuration issue. Option B is incorrect because BYOLLM is supported in production, provided it is correctly registered. Therefore, the error occurs because the LLM name or configuration ID does not match between sandbox and production, making Option C the correct answer.",
    "section": "testing"
  },
  {
    "id": 58,
    "text": "Universal Containers has multiple Salesforce orgs, each with a unique customer service agent where a verification agent must pass customer identity data to downstream agents handling account modifications. The customer ID must remain secure and persistent across agent handoffs without exposure to large language model (LLM) modification. What is the most appropriate configuration?",
    "options": [
      {
        "letter": "A",
        "text": "Implement a custom object to temporarily store verification status and have each agent query it via SOQL actions during execution."
      },
      {
        "letter": "B",
  ...
  {
    "id": 59,
    "text": "Universal Containers wants to test agents while preserving real data and isolating from production. Which environment should the company use with Testing Center?",
    "options": [
      {
        "letter": "A",
        "text": "Use personal developer orgs unrepresentative of production data,"
      },
      {
        "letter": "B",
        "text": "Use production org directly with test assertions."
      },
      {
        "letter": "C",
        "text": "Use sandbox environments replicated from production for safe testing,"
      }
    ],
    "answer": [
      "C"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "B",
        "text": "Prompt Builder must be used to assign the fields from the related list as a JSON format."
      },
      {
        "letter": "C",
  ...
  {
    "id": 61,
    "text": "What is a key benefit of the Agent-to-Agent (A2A) protocol?",
    "options": [
      {
        "letter": "A",
        "text": "Provides a standardized framework for cross-vendor agent discovery and communication"
      },
      {
        "letter": "B",
        "text": "Allows auto-onboard third-party agents without additional contracts, trust scores, or shared identity controls"
      },
      {
        "letter": "C",
        "text": "Provides a standardized runtime engine for internal agent discovery and communication"
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 62,
    "text": "Universal Containers (UC) is using Einstein Generative AI to generate an account summary. UC aims to ensure the content is safe and inclusive, utilizing the Einstein Trust Layer's toxicity scoring to assess the content's safety level. In the score of 1 indicate?",
    "options": [
      {
        "letter": "A",
        "text": "The response is the least toxic Einstein Generative AI Toxicity Scoring system, what does a toxicity category."
      },
      {
        "letter": "B",
        "text": "The response is not toxic."
      },
      {
        "letter": "C",
        "text": "The response is the most toxic."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 63,
    "text": "Universal Containers wants to assign agents to improve department efficiency. Which configuration ensures the right tasks are handled by the right agents?",
    "options": [
      {
        "letter": "A",
        "text": "SDR Agent for lead qualification, Service Agent for support tickets, Employee Agent for HR requests"
      },
      {
        "letter": "B",
        "text": "Sales Coach Agent for lead and service Agent for HR requests, and Support tickets to ensure cases are available"
      },
      {
        "letter": "C",
        "text": "One Service Agent to efficiently handle each of these scenarios, which reduces the number of agent types needed for support"
      }
    ],
    "answer": [
      "A"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "C",
        "text": "The Agentforce Service Agent user was not given the Allow View Knowledge permission set."
      }
    ],
    "answer": [
      "C"
    ...
    "multi": false,
    "explanation": "Universal Containers (UC) has deployed an Agentforce Service Agent on its website, but it's failing to provide answers from Salesforce Knowledge articles. Let's troubleshoot the issue. Option A: The Agentforce Service Agent user is not assigned the correct Agent Type License.There's no \" Agent Type License \" in Salesforceagent functionality is tied to Agentforce licenses (e.g., Service Agent license) and permissions. Licensing affects feature access broadly, but the specific issue of not retrieving Knowledge suggests a permission problem, not a license type, making this incorrect. Option B: The Agentforce Service Agent user needs to be created under the standard Agent Knowledge profile.No \" standard Agent Knowledge profile \" exists. The Agentforce Service Agent runs under a system user (e.g., \" Agentforce Agent User \") with a custom profile or permission sets. Profile creation isn't the issueaccess permissions are, making this incorrect. Option C: The Agentforce Service Agent user was not given the Allow View Knowledge permission set.The Agentforce Service Agent user requires read access to Knowledge articles to ground responses. The \" Allow View Knowledge \" permission (typically via the \" Salesforce Knowledge User \" license or a permission set like \" Agentforce Service Permissions \") enables this. If missing, the agent can't access Knowledge, even if articles are indexed, causing the reported failure. This is a common setup oversight and the likely issue, making it the correct answer.",
    "section": "agents"
  },
  {
    "id": 65,
  ...
  {
    "id": 66,
    "text": "A Universal Containers administrator is setting up Einstein Data Libraries. After creating a new library, the administrator notices that only the file upload option is available; there is no option to configure the library using a Salesforce Knowledge base. What is the most likely cause of this Issue?",
    "options": [
      {
        "letter": "A",
        "text": "The current Salesforce org lacks the necessary Einstein for Service permissions that support the Knowledge-based Data Library option, so only the file upload option is presented."
      },
      {
        "letter": "B",
        "text": "Salesforce Knowledge is not enabled in the organization; without Salesforce Knowledge enabled, the Knowledge-based data source option will not be available in Einstein Data Libraries."
      },
      {
        "letter": "C",
        "text": "The administrator is not using Lightning Experience, which is required to display all data source options, Including the Knowledge base option, when configuring Einstein Data Libraries."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 67,
    "text": "What is An Agentforce able to do when the \"Enrich event logs with conversation data \" setting in Agent is enabled?",
    "options": [
      {
        "letter": "A",
        "text": "View the user click path that led to each copilot action."
      },
      {
        "letter": "B",
        "text": "View session data including user Input and copilot responses for sessions over the past 7 days."
      },
      {
        "letter": "C",
        "text": "Generate details reports on all Copilot conversations over any time period."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 68,
    "text": "When configuring a prompt template, an Agentforce Specialist previews the results of the prompt template they've written. They see two distinct text outputs: Resolution and Response. Which information does the Resolution text provide?",
    "options": [
      {
        "letter": "A",
        "text": "It shows the full text that is sent to the Trust Layer."
      },
      {
        "letter": "B",
        "text": "It shows the response from the LLM based on the sample record."
      },
      {
        "letter": "C",
        "text": "It shows which sensitive data is masked before it is sent to the LLM."
      }
    ],
    "answer": [
      "B"
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "The records related to the prompt have not been selected."
      },
      {
        "letter": "B",
        "text": "The prompt has not been saved and activated,"
      },
      {
        "letter": "C",
        "text": "A merge field has not been inserted in the prompt."
      }
    ],
    "answer": [
      "A"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "B",
        "text": "Dynamic grounding with secure data retrieval"
      },
      {
        "letter": "C",
  ...
  {
    "id": 74,
    "text": "Universal Containers (UC) is setting up a new Agentforce Service Agent. The company has sensitive medical product research stored internally and wants to ensure the agent cannot access it. What should UC da?",
    "options": [
      {
        "letter": "A",
      ...
      {
        "letter": "C",
        "text": "Follow the principle of least privilege and avoid granting permission to view the Medical Product object or related"
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 75,
    "text": "In Model Playground, which hyperparameters of an existing Salesforce-enabled foundational model can An Agentforce change?",
    "options": [
      {
        "letter": "A",
        "text": "Temperature, Frequency Penalty, Presence Penalty"
      },
      {
        "letter": "B",
        "text": "Temperature, Top-k sampling, Presence Penalty"
      },
      {
        "letter": "C",
        "text": "Temperature, Frequency Penalty, Output Tokens"
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 76,
    "text": "Where should the Agentforce Specialist go to add/update actions assigned to a copilot?",
    "options": [
      {
        "letter": "A",
        "text": "Copilot Actions page, the record page for the copilot action, or the Copilot Action Library tab"
      },
      {
        "letter": "B",
        "text": "Copilot Actions page or Global Actions"
      },
      {
        "letter": "C",
        "text": "Copilot Detail page, Global Actions, or the record page for the copilot action"
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 77,
    "text": "How does the AI Retriever function within Data Cloud?",
    "options": [
      {
        "letter": "A",
        "text": "It performs contextual searches over an indexed repository to quickly fetch the most relevant documents, enabling grounding AI responses with trustworthy, verifiable information."
      },
      {
        "letter": "B",
        "text": "It monitors and aggregates data quality metrics across various data pipelines to ensure only high- integrity data is used for strategic decision-making."
      },
      {
        "letter": "C",
        "text": "It automatically extracts and reformats raw data from diverse sources into standardized datasets for use in historical trend analysis and forecasting."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 79,
    "text": "Universal Containers deploys a new Agentforce Service Agent into the company's website but is getting feedback that the Service Agent is not providing answers to customer questions that are found in the company's Salesforce Knowledge articles. What is the likely issue?",
    "options": [
      {
        "letter": "A",
        "text": "The Agentforce Service Agent user was not given the Allow View Knowledge permission set."
  ...
  {
    "id": 80,
    "text": "Universal Containers (UC) is scaling its Agentforce deployment and needs to securely connect its AI agents to a growing number of external enterprise data systems and local developer environments. Instead of building custom integration logic and bespoke Application Programming Interfaces (APIs) for each new data source, the Agentforce Specialist recommends leveraging the Model Context Protocol (MCP). What is the primary purpose of using an open standard like MCP in this scenario?",
    "options": [
      {
        "letter": "A",
        "text": "To standardize the secure connection and delivery of context between the AI models and various local or remote data sources."
      },
      {
        "letter": "B",
        "text": "To replace the need for Retrieval-Augmented Generation (RAG) by storing all external data natively within the large language model (LLM)'s weights."
      },
      {
        "letter": "C",
        "text": "To allow the agent to autonomously negotiate task delegation with third-party supply chain agents."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 81,
    "text": "Universal Containers built a Field Generation prompt template that worked for many records, but users are reporting random failures with token limit errors. What is the cause of the random nature of this error?",
    "options": [
      {
        "letter": "A",
        "text": "The template type needs to be switched to Flex to accommodate the variable amount of tokens generated by the prompt grounding."
      },
      {
        "letter": "B",
      ...
      {
        "letter": "C",
        "text": "The number of tokens that can be processed by the LLM varies with total user demand."
      }
    ],
    "answer": [
      "B"
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "The flow was not manually activated in the production org after the deployment."
      },
      {
        "letter": "B",
        "text": "The user in production does not have permission to run the flow."
      },
      {
        "letter": "C",
        "text": "The change set did not include the dependent Apex classes for the flow."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 84,
    "text": "An Agentforce is setting up a new org and needs to ensure that users can create and execute prompt templates. The Agentforce Specialist is unsure which roles are necessary for these tasks. Which permission sets should the Agentforce Specialist assign to users who need to create and execute prompt templates?",
    "options": [
      {
        "letter": "A",
        "text": "Prompt Template Manager for creating templates and Data Cloud Admin for executing templates"
      },
      {
        "letter": "B",
        "text": "Prompt Template Manager for creating templates and Prompt Template User for executing templates"
      },
      {
        "letter": "C",
        "text": "Data Cloud Admin for creating templates and Prompt Template User for executing templates"
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 85,
    "text": "Universal Containers (UC) is tracking web activities in Data Cloud for a unified contact, and wants to use that in a prompt template to help extract insights from the data. Assuming that the Contact object is one of the objects associated with the prompt template, what is a valid way for DC to do this?",
    "options": [
      {
        "letter": "A",
        "text": "Call the prompt directly from Data Cloud with a web tracing activity included in the prompt definition."
      },
      {
        "letter": "B",
        "text": "Add the activity records as an enrichment related list to the Contact then pass the Contact into a prompt template workspace using related list grounding."
      },
      {
        "letter": "C",
        "text": "Create a prompt template that takes a list of all Data Cloud activity records as input to pass to the large language model (LLM)."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 86,
    "text": "Universal Containers (UC) is building a Flex prompt template. UC needs to use data returned by the flow in the prompt template. Which flow element should UC use?",
    "options": [
      {
        "letter": "A",
        "text": "Add Flex Instructions"
      },
      {
        "letter": "B",
        "text": "Add Prompt Instructions"
      },
      {
        "letter": "C",
        "text": "Add Flow Instructions"
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 87,
    "text": "The Agentforce Specialist of Northern Trail Outfitters reviewed the organization's data masking settings within the Configure Data Masking menu within Setup. Upon assessing all of the fields, a few additional fields were deemed sensitive and have been masked within Einstein's Trust Layer. Which steps should the Agentforce Specialist take upon modifying the masked fields?",
    "options": [
      {
        "letter": "A",
        "text": "Turn off the Einstein Trust Layer and turn it on again."
      },
      {
        "letter": "B",
        "text": "Test and confirm that the responses generated from prompts that utilize the data and masked data do not adversely affect the quality of the generated response"
      },
      {
        "letter": "C",
        "text": "Turn on Einstein Feedback so that end users can report if there are any negative side effects on AI features."
      }
    ],
    "answer": [
      "B"
    ...
    "multi": false,
    "explanation": "After modifying masked fields in Einstein's Trust Layer, the next important step is to test and confirm that the responses generated by prompts utilizing the newly masked data still meet quality standards. This ensures that masking sensitive information does not negatively impact the usefulness or accuracy of the AIgenerated content. Thorough testing helps identify any issues in prompt performance that could arise due to masking, and adjustments can be made if needed. Option B is correct because testing the effects of masking on AI responses is a critical step in ensuring AI continues to function as expected. Option A (turning off and on the Einstein Trust Layer) is unnecessary after changing the masked fields. Option C (turning on Einstein Feedback) allows for user feedback but is not a direct step following field masking modifications. Salesforce Einstein Trust Layer Overview: einstein_trust_layer.htm",
    "section": "prompt"
  },
  {
    "id": 88,
    "text": "A Salesforce Agentforce Specialist is reviewing the feedback from a customer about the ineffectiveness of the prompt template. What should the Agentforce Specialist do to ensure the prompt template's effectiveness?",
    "options": [
      {
        "letter": "A",
        "text": "Monitor and refine the template based on user feedback."
      },
      {
        "letter": "B",
        "text": "Use the Prompt Builder Scorecard to help monitor."
      },
      {
        "letter": "C",
        "text": "Periodically change the templates grounding object."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 89,
    "text": "Universal Containers wants its AI agent to answer customer questions with precise and up-to- date information. How does an Agentforce Data Library simplify and enable this?",
    "options": [
      {
        "letter": "A",
        "text": "It automates the ingestion, taxonomical classification and storage of knowledge in Data Cloud for precision keyword search retrieval to ground prompts and agents with relevant information."
      },
      {
        "letter": "B",
        "text": "It automates the ingestion, Indexing of data, and creates a default retriever to be used in prompts and agents for grounding with relevant information."
      },
      {
        "letter": "C",
        "text": "It automates the ingestion and optical character recognition (OCR) processing of any PDF, and indexes them to enable regular SQL query retrieval to ground prompts and agents with relevant information."
      }
    ],
    "answer": [
      "B"
    ...
    "multi": false,
    "explanation": "Why is \" Automates Ingestion, Indexing, and Default Retriever Creation \" the correct answer? An Agentforce Data Library is a key component in ensuring that an AI agent provides precise and up- to-date responses by: # Automating data ingestion # Brings in data from various sources. # Indexing the data # Organizes it efficiently for AI retrieval. # Creating a default retriever # Enables the AI to fetch relevant data dynamically when answering customer queries. Key Features of an Agentforce Data Library: Automates Data Ingestion Integrates real-time and historical data into Salesforce Data Cloud. Ensures that relevant updates are continuously fed into the AI system. Indexes Data for Efficient Retrieval Enhances searchability for quick, contextaware responses. Enables fast AI response times while maintaining accuracy. Creates a Default Retriever AI agents use the retriever to fetch the most relevant and current information. The retriever grounds AI-generated responses using structured and indexed data. Why Not the Other Options? # A. Automates ingestion, taxonomical classification, and precision keyword search retrieval Incorrect because Agentforce does not rely on keyword searches but on indexing and AI-driven retrieval. # C. Automates ingestion and OCR processing of PDFs Incorrect because OCR (Optical Character Recognition) is not the primary function of an Agentforce Data Library. AI grounding is based on indexed and structured data, not raw OCRextracted text. Agentforce Specialist References Salesforce AI Specialist Material explains that Agentforce Data Libraries automate data ingestion, indexing, and retriever setup for AI-powered responses. Salesforce Instructions for Certification confirm that AI responses are grounded in structured and indexed Data Libraries.",
    "section": "data"
  },
  {
    "id": 90,
    "text": "An Agentforce has created a copilot custom action using flow as the reference action type. However, it is not delivering the expected results to the conversation preview, and therefore needs troubleshooting. What should the Agentforce Specialist do to identify the root cause of the problem?",
    "options": [
      {
        "letter": "A",
        "text": "In Copilot Builder within the Dynamic Panel, turn on dynamic debugging to show the inputs and outputs."
      },
      {
        "letter": "B",
        "text": "Copilot Builder within the Dynamic Panel, confirm selected action and observe the values in Input and Output sections."
      },
      {
        "letter": "C",
        "text": "In Copilot Builder, verify the utterance entered by the user and review session event logs for debug information."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 91,
    "text": "After creating a foundation model in Einstein Studio, which hyperparameter should An Agentforce use to adjust the balance between consistency and randomness of a response?",
    "options": [
      {
        "letter": "A",
        "text": "Presence Penally"
      },
      {
        "letter": "B",
        "text": "Variability"
  ...
  {
    "id": 92,
    "text": "Coral Cloud Resorts wants visibility into credit usage associated with testing. Which feature supports this?",
    "options": [
      {
        "letter": "A",
        "text": "Agentforce Analytics"
      },
      {
        "letter": "B",
        "text": "Digital Wallet"
  ...
  {
    "id": 93,
    "text": "Universal Containers wants to create a prompt template that consistently extracts a customer's specific product model number and quantity from an email inquiry to draft a response back to the customer. Which best practice should UC implement to achieve this goal?",
    "options": [
      {
        "letter": "A",
        "text": "Incorporate open-ended questions to encourage detailed responses"
      },
      {
        "letter": "B",
        "text": "Provide clear, positive instructions and use few-shot examples"
      },
      {
        "letter": "C",
        "text": "Use a high temperature setting to increase creative output"
      }
    ],
    "answer": [
      "B"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "B",
        "text": "Draft Survey Request Email"
      },
      {
        "letter": "C",
        "text": "Issue and Revolution"
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 95,
    "text": "Universal Containers (UC) plans to answer questions based on similar cases that have been successfully resolved in the past. What should UC consider when implementing this approach?",
    "options": [
      {
        "letter": "A",
        "text": "No action is needed, as past cases are used to answer the question."
      },
      {
        "letter": "B",
        "text": "Create a data model object (DMO) based on Case object and create an index on it."
      },
      {
        "letter": "C",
  ...
  {
    "id": 96,
    "text": "During retrieval-augmented generation (RAG) quality testing, an Agentforce Specialist notices that tabular information from a custom Data 360 Document Ingestion Pipeline is losing its context because the data is scattered across multiple separate chunks. What is the most appropriate approach to resolve this?",
    "options": [
      {
        "letter": "A",
        "text": "Change the search index's parser from the default to Docling."
      },
      {
        "letter": "B",
        "text": "Use an ensemble retriever to stitch multiple chunks back together dynamically."
      },
      {
        "letter": "C",
        "text": "Switch the search index configuration to use only keyword search scoring."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 97,
    "text": "An account manager is preparing for an upcoming customer call and wishes to get a snapshot of key data points from accounts, contacts, leads, and opportunities in Salesforce. Which feature provides this?",
    "options": [
      {
        "letter": "A",
        "text": "Sales Summaries"
      },
      {
        "letter": "B",
        "text": "Sales Insight Summary"
      },
      {
        "letter": "C",
        "text": "Work Summaries"
  ...
  {
    "id": 98,
    "text": "Universal Containers is deploying a new customer service agent using Agent Script. The Agentforce Specialist needs to update conversational state, navigate between different subagents formerly known as topics, and hand off conversations to a human agent when necessary. To minimize technical debt, the Agentforce Specialist wants to implement these capabilities without building any custom backend code. Which statement correctly describes how the Agentforce Specialist can implement these specific requirements?",
    "options": [
      {
        "letter": "A",
        "text": "The Agentforce Specialist can use @utils.setVariables, @utils.transition, and @utils.escalate directly."
      },
      {
        "letter": "B",
        "text": "The Agentforce Specialist can use most utilities directly, but @utils.escalate requires a custom Apex class to define the escalation queue."
      },
      {
        "letter": "C",
        "text": "The Agentforce Specialist can use most utilities out of the box, but @utils.transition requires a flow to define the target subagent at runtime."
      }
    ],
    "answer": [
      "A"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "B",
        "text": "Create an Omni-Channel flow that routes messages to the agent."
      },
      {
        "letter": "C",
  ...
  {
    "id": 100,
    "text": "Universal Containers is testing an agent with a \"Reset Password\" action restricted by the guard available when @variables.isVerified == True. During a single conversation turn, the large language model successfully sets the isVerified flag to true using @utils.setVariables, but fails to invoke the \"Reset Password\" action immediately afterward. What must the Agentforce Specialist consider regarding how the reasoning engine evaluates action availability?",
    "options": [
      {
        "letter": "A",
        "text": "The action is available from the start; the reasoning engine's intent to solve the user's issue automatically overrides the available when guard."
      },
      {
        "letter": "B",
        "text": "The action becomes available immediately; available when conditions dynamically re-evaluate after every variable change within a single turn."
      },
      {
        "letter": "C",
        "text": "The action remains unavailable for that turn; available when conditions control action visibility to the LLM and evaluate before the reasoning cycle begins, so the action will not be callable until the next turn."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 101,
    "text": "Universal Containers is evaluating Einstein Generative AI features to improve the productivity of the service center operation. Which features should the Agentforce Specialist recommend?",
    "options": [
      {
        "letter": "A",
        "text": "Service Replies and Case Summaries"
      },
      {
        "letter": "B",
        "text": "Service Replies and Work Summaries"
      },
      {
        "letter": "C",
        "text": "Reply Recommendations and Sales Summaries"
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 102,
    "text": "Universal Containers has deployed Agentforce to handle customer order tracking, returns, and loyalty support. The agent needs to balance conversational flexibility for customer inquiries with guaranteed execution of identity verification steps before accessing the account information. The development team is evaluating how to structure the agent's instruction pattern to meet both requirements. Which statement correctly describes hybrid reasoning in Agentforce Agent Script?",
    "options": [
      {
        "letter": "A",
        "text": "Hybrid reasoning uses multiple large language model (LLM) models simultaneously, with one model handling conversational responses and another model executing deterministic business logic through Flow integration."
      },
      {
        "letter": "B",
        "text": "Hybrid reasoning requires Canvas View for declarative instructions and Script View for procedural instructions, as each editor provides different capabilities for the respective instruction types."
      },
      {
        "letter": "C",
        "text": "Hybrid reasoning combines declarative natural language instructions that allow large language model (LLM) interpretation with procedural instructions using the - > prefix that enforce guaranteed execution order."
      }
    ],
    "answer": [
      "C"
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "Assign the user in the highest-level role within the North America role hierarchy as the SDR Agent User."
      },
      {
        "letter": "B",
        "text": "Grant View All record permission of the Lead object to the 'Einstein Agent User' profile,"
      },
      {
        "letter": "C",
        "text": "Create a criteria-based sharing rule to grant access to targeted lead records to SDR Agent User."
      }
    ],
    "answer": [
      "C"
    ...
    "multi": false,
    "explanation": "According to the AgentForce Security and Data Access Configuration Guide, the best practice for ensuring an agent (such as an SDR Agent) can access specific records while maintaining security is to use criteria-based sharing rules. The documentation states: \"When an AI Agent needs access to a subset of records (for example, regional leads), create a sharing rule granting access to that agent's user context based on defined criteria such as region or ownership.\" Option A (assigning the highest- level role) provides excessive access beyond the intended scope, violating the principle of least privilege. Option B (View All permission) gives global object access, which is not secure. Therefore, Option C ensures that the SDR Agent has controlled, regionspecific access to lead records.",
    "section": "agents"
  },
  {
    "id": 104,
    ...
    "options": [
      {
        "letter": "A",
        "text": "Both patterns execute the action on every turn automatically; the difference is purely syntactic, as the run command is simply the newer notation for Agent Script."
      },
      {
        "letter": "B",
        "text": "The run command is only valid when nested inside reasoning.actions blocks to pass parameters; the Agentforce Specialist must list it under reasoning.actions for the large language model (LLM) to access it."
      },
      {
        "letter": "C",
        "text": "Listing an action under reasoning.actions makes it a subjective tool that the large language model (LLM) decides whether to call; calling it with the run command forces guaranteed execution every time."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 108,
    "text": "Universal Containers wants to incorporate CRM data as well-formatted JSON in a prompt to a large language model (LLM). What is an important consideration for this requirement?",
    "options": [
      {
        "letter": "A",
        "text": "\" CRM data to JSON \" checkbox must be selected when creating a prompt template."
      },
      {
        "letter": "B",
        "text": "Apex code can be used to return a JSON formatted merge field."
      },
      {
        "letter": "C",
        "text": "JSON format should be enabled in Prompt Builder Settings."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 109,
    "text": "Universal Containers has set up a Service Agent to allow customers to look up their order status. The topic setup includes: Name: Order Inquiry Classification Description: Handles user requests to look up order status, including tracking details and delivery estimates for orders placed within the last 90 days. Scope: Your job is only to assist authenticated users in looking up the status of their orders placed within the last 90 days. If the order is pending delivery, provide the tracking number and estimated delivery date. Do not handle inquiries for orders older than 90 days. Which information will be used by the Agentforce reasoning engine to choose this topic?",
    "options": [
      {
        "letter": "A",
        "text": "Topic Name and Classification Description"
      },
      {
        "letter": "B",
        "text": "Topic Name and Scope"
      },
      {
        "letter": "C",
        "text": "Classification Description and Scope"
      }
    ],
    "answer": [
      "C"
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "The user does not have permission to access the fields."
      },
      {
        "letter": "B",
        "text": "The user's locale language is not supported by Prompt Builder."
      },
      {
        "letter": "C",
        "text": "The user does not have Einstein Sales Emails permission assigned."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 111,
    "text": "An Agentforce configured Data Masking within the Einstein Trust Layer. How should the Agentforce Specialist begin validating that the correct fields are being masked?",
    "options": [
      {
        "letter": "A",
        "text": "Use a Flow-based resource in Prompt Builder to debug the fields' merge values using Flow Debugger."
      },
      {
        "letter": "B",
        "text": "Request the Einstein Generative AI Audit Data from the Security section of the Setup menu."
      },
      {
        "letter": "C",
        "text": "Enable the collection and storage of Einstein Generative AI Audit Data on the Einstein Feedback setup page."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 112,
    "text": "The AgentForce Specialist for Cloud Kicks wants to create an agent that will allow the sales staff to schedule their daily tasks and assist in providing detailed explanations behind product prices and deals. Following Salesforce best practices, which type of agent should they create?",
    "options": [
      {
        "letter": "A",
        "text": "Service Agent"
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "Create an agent action referencing the password reset Flow, assign it to the identity verification subagent, and call it deterministically from the subagent's reasoning block using Agent Script conditional logic."
      },
      {
        "letter": "B",
        "text": "Create a separate subagent named Password Reset, configure it with an action that invokes the Flow, and pass the identity verification variable as context so the subagent's instructions can reference the verified status before proceeding."
      },
      {
        "letter": "C",
        "text": "Add an instruction to the identity verification subagent directing the agent to trigger the password reset Flow once identity is confirmed, and store the customer's reset intent in a conversation variable so the reasoning engine can reference it when deciding whether to proceed."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 114,
    "text": "Universal Containers has a requirement to provide a sales summary for its sales reps who are using Employee Agents, but they are not happy with the default answer. Which best practice should the AgentForce Specialist recommend?",
    "options": [
      {
        "letter": "A",
        "text": "Create a Record Summary custom prompt template."
      },
      {
        "letter": "B",
        "text": "Create a Knowledge Answer custom prompt template."
      },
      {
        "letter": "C",
        "text": "Update the standard record summary action."
      }
    ],
    "answer": [
      "A"
    ...
    "multi": false,
    "explanation": "Comprehensive and Detailed Explanation From Exact Extract of AgentForce Documents: According to the AgentForce Prompt Customization and Template Development Guide, when an organization wants to modify or enhance how structured data (like Salesforce records) is summarized or presented by an agent, the correct approach is to create a Record Summary custom prompt template. Record Summary templates allow specialists to tailor how the agent interprets and communicates record information - such as opportunities, accounts, or sales summaries - ensuring the output align s with company-specific terminology, tone, and data needs. Option B, the Knowledge Answer template, is used when the agent must answer queries grounded in unstructured text sources (e.g., Knowledge articles), not structured CRM data. Option C, updating the standard record summary action, is not recommended because it may impact other agents or system actions globally, and Salesforce documentation advises customizing through new templates instead of overwriting defaults. Therefore, the correct best practice is Option A - Create a Record Summary custom prompt template, providing tailored and controlled responses specific to Universal Containers' sales summary requirements.",
    "section": "prompt"
  },
  {
    "id": 115,
  ...
  {
    "id": 116,
    "text": "Universal Containers is developing an Agentforce Service Agent to handle a complex, multi- step customer onboarding process. To better organize the conversational logic, the Agentforce Specialist splits the process across two distinct subagents and places the setup configuration for the second step inside the before_reasoning block of the new subagent. During testing, when the agent transitions to this new subagent mid-conversation, the conversation occasionally stalls or behaves unexpectedly. What is the risk the Agentforce Specialist must consider regarding the execution timing of before_reasoning?",
    "options": [
      {
        "letter": "A",
        "text": "The before_reasoning block will only run once and sets the immutable variables."
      },
      {
        "letter": "B",
        "text": "The before_reasoning block runs at the start of the next turn after a transition."
      },
      {
        "letter": "C",
        "text": "The before_reasoning block only runs on the very first turn after the agent launches."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 117,
    "text": "What is true of Agentforce Testing Center?",
    "options": [
      {
        "letter": "A",
        "text": "Running tests risks modifying CRM data in a production environment."
      },
      {
        "letter": "B",
        "text": "Running tests does not consume Einstein Requests."
      },
      {
        "letter": "C",
        "text": "Agentforce Testing Center can only be used in a production environment."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 119,
    "text": "Universal Containers (UC) wants to enable its sales reps to explore opportunities that are similar to previously won opportunities by entering the utterance, \" Show me other opportunities like this one. \" How should UC achieve this with Agents?",
    "options": [
      {
        "letter": "A",
        "text": "Use the standard Agent action."
      },
      {
        "letter": "B",
        "text": "Create a custom Agent action calling a flow."
      },
      {
        "letter": "C",
        "text": "Create a custom Agent action calling an Apex class."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 120,
    "text": "Universal Containers is setting up the data library configuration within the Agentforce Builder. What is true regarding Agentforce Data Libraries?",
    "options": [
      {
        "letter": "A",
        "text": "Only data library owners can assign it to the agent."
      },
      {
        "letter": "B",
        "text": "Each data category can only have one data library."
      },
      {
        "letter": "C",
        "text": "An agent can have only one data library assigned to it."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 123,
    "text": "Universal Containers is very concerned about security compliance and wants to understand: Which prompt text is sent to the large language model (LLM) * How it is masked * The masked response What should the Agentforce Specialist recommend?",
    "options": [
      {
        "letter": "A",
        "text": "Ingest the Einstein Shield Event logs into CRM Analytics."
      },
      {
        "letter": "B",
        "text": "Review the debug logs of the running user."
      },
      {
        "letter": "C",
        "text": "Enable audit trail in the Einstein Trust Layer."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 125,
    "text": "An Agentforce Specialist is testing an agent with Testing Center. The test results show that an agent correctly identifies the right subagent to handle an utterance, but it fails to select all necessary actions within that subagent. Which evaluation metric specifically identifies this failure?",
    "options": [
      {
        "letter": "A",
  ...
  {
    "id": 126,
    "text": "An Agentforce Specialist is creating a custom agent action. The topic is selected correctly, but the action is not. Which setting should the Agentforce Specialist test and iterate on to ensure the action performs as expected?",
    "options": [
      {
        "letter": "A",
        "text": "Action Scape"
    ...
    "multi": false,
    "explanation": "Per the AgentForce Custom Action Development Guide, if a topic is correctly triggered but the wrong action is executed, the issue typically lies in action instructions. The documentation notes: \"Action instructions provide the LLM with explicit guidance on when and how to use a given action. Poorly written or ambiguous instructions can cause the reasoning engine to select an incorrect action, even within the right topic.\" Option A (Action Scope) defines data inputs/outputs, not reasoning behavior. Option C (Classification Description) pertains to topic-level intent, not action execution. Thus, Option B - refining and testing the action instructions - ensures accurate behavior and actio n selection.",
    "section": "agents"
  },
  {
    "id": 127,
    "text": "Universal Containers is deploying two agents simultaneously: an internal Sales Productivity Agent for employees and a customer-facing Service Agent on its Experience Cloud site. An Agentforce Specialist is configuring permissions and needs to understand the correct security context for each. Which statement accurately describes the execution model?",
    "options": [
      {
        "letter": "A",
        "text": "The customer-facing Service Agent inherits the security context of the Experience Cloud site's guest user profile by default, requiring guest profile object permissions to be configured for all actions the agent executes."
      },
      {
        "letter": "B",
        "text": "The internal Sales Productivity Agent executes actions using the authenticated Salesforce employee's own permissions, while the customerfacing Service Agent executes actions as a dedicated Einstein Service Agent User with its own permission set."
      },
      {
        "letter": "C",
        "text": "Both the internal Sales Productivity Agent and the customer-facing Service Agent execute actions as a dedicated Einstein Service Agent User with its own permission set that is configured as required for the agent."
      }
    ],
    "answer": [
      "B"
    ...
    "multi": false,
    "explanation": "The correct answer is B. Internal employee-facing agents operate within the authenticated Salesforce user's access model, so actions must respect the employee's profile, permission sets, sharing, and field- level security. A customerfacing Service Agent deployed through Experience Cloud is different: it is configured around an agent user/service agent execution identity, and Salesforce guidance stresses assigning the correct permissions to that agent user rather than relying on the site guest profile. Option A is wrong because a logged-in Experience Cloud deployment should not be treated as a guest-user execution model by default. Option C is also wrong because it incorrectly applies the dedicated Service Agent User model to the internal Sales Productivity Agent. The exam distinction is usercontext execution for internal productivity versus dedicated service-agent execution for customer-facing service automation.",
    "section": "agents"
  },
  {
    "id": 128,
    "text": "Which useful metrics does Agentforce Observability provide to a customer service team related to a Customer Service Agent?",
    "options": [
      {
        "letter": "A",
        "text": "Call deflection rates, cost per interaction, and memory consumption"
      },
      {
        "letter": "B",
        "text": "Call deflection rates, productivity, and abandoned session rates"
      },
      {
        "letter": "C",
        "text": "Call deflection rates, abandoned session rates, and user intent ratings"
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 129,
    "text": "An Agentforce Specialist is preparing to upload several PDF policy documents to a new file- based Agentforce Data Library. To leverage advanced processing with Intelligent Context, how should the Agentforce Specialist proceed?",
    "options": [
      {
        "letter": "A",
        "text": "Upload up to five PDFs that are 100 MB or less to allow the system to evaluate the optimal indexing configuration."
      },
      {
        "letter": "B",
        "text": "Upload up to five PDFs that are 10 MB or less to allow the system to evaluate the optimal indexing configuration."
      },
      {
        "letter": "C",
        "text": "Manually enable Intelligent Context in Data 360 prior to uploading the PDF files."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 130,
    "text": "An Agentforce wants to use the related lists from an account in a custom prompt template. What should the Agentforce Specialist consider when configuring the prompt template?",
    "options": [
      {
        "letter": "A",
        "text": "The text encoding (for example, UTF-8, ASCII) option"
      },
      {
        "letter": "B",
        "text": "The maximum number of related list merge fields"
      },
      {
        "letter": "C",
        "text": "The choice between XML and JSON rendering formats for the list"
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 131,
    "text": "Universal Containers (UC) is using standard Service AI Grounding. UC created a custom rich text field to be used with Service AI Grounding. What should UC consider when using standard Service AI Grounding?",
    "options": [
      {
        "letter": "A",
        "text": "Service AI Grounding only works with Case and Knowledge objects."
      },
      {
        "letter": "B",
        "text": "Service AI Grounding only supports String and Text Area type fields."
      },
      {
        "letter": "C",
        "text": "Service AI Grounding visibility works m system mode."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 132,
    "text": "Universal Containers (UC) is experimenting with using public Generative AI models and is familiar with the language required to get the information it needs. However, it can be time- consuming for both UC's sales and service reps to type in the prompt to get the information they need, and ensure prompt consistency. Which Salesforce feature should the company use to address these concerns?",
    "options": [
      {
        "letter": "A",
        "text": "Agent Builder and Action: Query Records."
      },
      {
        "letter": "B",
        "text": "Einstein Prompt Builder and Prompt Templates."
      },
      {
        "letter": "C",
        "text": "Einstein Recommendation Builder."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 133,
    "text": "Universal Containers has implemented an agent that answers questions based on Knowledge articles. Which topic and Agent Action will be shown in the Agent Builder?",
    "options": [
      {
        "letter": "A",
        "text": "General Q & A topic and Knowledge Article Answers action."
      },
      {
        "letter": "B",
        "text": "General CRM topic and Answers Questions with LLM Action."
      },
      {
        "letter": "C",
        "text": "General FAQ topic and Answers Questions with Knowledge Action."
      }
    ],
    "answer": [
      "C"
    ...
    "multi": false,
    "explanation": "UC's agent answers questions using Knowledge articles, configured in Agent Builder. Let's identify the topic and action. Option A: General Q & A topic and Knowledge Article Answers action. \" General Q & A \" is not a standard topic name in Agentforce, and \" Knowledge Article Answers \" isn't a predefined action. This lacks specificity and doesn't match documentation, making it incorrect. Option B: General CRM topic and Answers Questions with LLM Action. \" General CRM \" isn't a default topic, and \" Answers Questions with LLM \" suggests raw LLM responses, not Knowledgegrounded ones. This doesn't align with the Knowledge focus, making it incorrect. Option C: General FAQ topic and Answers Questions with Knowledge Action.In Agent Builder, the \" General FAQ \" topic is a common default or starting point for questionanswering agents. The \" Answers Questions with Knowledge \" action (sometimes styled as \" Answer with Knowledge \") is a prebuilt action that retrieves and grounds responses with Knowledge articles. This matches UC's implementation and is explicitly supported in documentation, making it the correct answer.",
    "section": "agents"
  },
  {
    "id": 134,
    "text": "Universal Containers (UC) is using related list merge fields in a prompt template associated with an Account object in Prompt Builder. What should UC consider?",
    "options": [
      {
        "letter": "A",
        "text": "The Activities related list on the Account object is not supported because it is a polymorphic field."
      },
      {
        "letter": "B",
        "text": "If person accounts have been enabled, merge fields will not be available for the Account object."
      },
      {
        "letter": "C",
        "text": "Prompt generation will yield no response when there is no related list associated with an Account in runtime."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 138,
    "text": "Universal Containers wants to keep retrieval accurate as product documentation changes frequently. Which approach should the company implement?",
    "options": [
      {
        "letter": "A",
        "text": "Leave embedding unchanged even if content is updated."
      },
      {
        "letter": "B",
        "text": "Rebuild the search index."
      },
      {
        "letter": "C",
        "text": "Manually delete the stale data chunks."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 139,
    "text": "The compliance team at Universal Containers has determined that a specific customer service prompt must only process data through a secure, self-hosted Amazon Bedrock model and must be prevented from accessing the default OpenAI models. How should the Agentforce Specialist configure this specific model routing?",
    "options": [
      {
        "letter": "A",
        "text": "Assign a permission set to the dedicated Agent User that restricts Read access to the default Salesforce large language model (LLM) metadata records."
      },
      {
        "letter": "B",
        "text": "Configure a Data 360 Private Connect endpoint that automatically reroutes all Agentforce requests away from the default large language model (LLM) Gateway."
      },
      {
        "letter": "C",
        "text": "Register the model as a BYOLLM in Einstein Studio, then explicitly select this model when configuring the prompt template."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 141,
    "text": "When is the Agent-to-Agent (A2A4) protocol an appropriate communication choice?",
    "options": [
      {
        "letter": "A",
        "text": "When agents need to invoke third-party API"
      },
      {
        "letter": "B",
        "text": "When agents need to access tools"
      },
      {
        "letter": "C",
        "text": "When agents need to collaborate"
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 142,
    "text": "Once a data source is chosen for an Agentforce Data Library, what is true about changing that data source later?",
    "options": [
      {
        "letter": "A",
        "text": "The data source can be changed through the Data Cloud settings."
      },
      {
        "letter": "B",
        "text": "The Data Retriever can be reconfigured to use a different data source."
      },
      {
        "letter": "C",
        "text": "The data source cannot be changed after it is selected."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 144,
    "text": "Universal Containers wants to use an external large language model (LLM) in Prompt Builder. What should An Agentforce recommend?",
    "options": [
      {
        "letter": "A",
        "text": "Use Apex to connect to an external LLM and ground the prompt."
      },
      {
        "letter": "B",
        "text": "Use BYO-LLM functionality in Einstein Studio."
      },
      {
        "letter": "C",
        "text": "Use Flow and External Services to bring data from an external LLM."
      }
    ],
    "answer": [
      "B"
  ...
  },
  {
    ...
    "multi": false,
    "explanation": "In AgentForce documentation on Knowledge Indexing and Chunking Strategies, Salesforce emphasizes that when uploading large volumes of structured content such as HTML or documentation files, the system should use section-aware chunking. The guide states: \"Section- aware chunking preserves the logical boundaries of headings, paragraphs, and sub-sections in structured documents like HTML or PDF files, allowing the agent to retrieve contextually accurate and relevant responses quickly.\" This method ensures that the agent does not split content midsection or lose contextual relationships between headings and body text. It enhances both retrieval speed and answer precision. Option A, semantic-based passage extraction, is better suited for free-text knowledge bases, where meaning needs to be inferred. Option B, conversation-based chunking, applies only to chat logs or dialogue histories. For HTML documentation and structured articles, sectionaware chunking ensures optimized retrieval and minimal latency in AgentForce responses.",
    "section": "data"
  },
  {
    "id": 146,
    "text": "Universal Containers (UC) is implementing Agentforce Service Agent on Email, UC made an email template and now needs to connect it to a Service Agent. What should an Agentforce Specialist recommend?",
    "options": [
      {
        "letter": "A",
        "text": "Create an Email Configuration for the Service Agent."
      },
      {
        "letter": "B",
        "text": "Create an Omni-Channel flow to point to an email template."
      },
      {
        "letter": "C",
        "text": "No action needed; the Service Agent connects automatically."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 147,
    "text": "Universal Containers wants to be able to detect with a high level confidence if content generated by a large language model (LLM) contains toxic language. Which action should an Al Specialist take in the Trust Layer to confirm toxicity is being appropriately managed?",
    "options": [
      {
        "letter": "A",
        "text": "Access the Toxicity Detection log in Setup and export all entries where isToxicityDetected is true."
      },
      {
        "letter": "B",
        "text": "Create a flow that sends an email to a specified address each time the toxicity score from the response exceeds a predefined threshold."
      },
      {
        "letter": "C",
        "text": "Create a Trust Layer audit report within Data Cloud that uses a toxicity detector type filter to display toxic responses and their respective scores."
      }
    ],
    "answer": [
      "C"
  ...
  },
  {
    ...
    "multi": false,
    "explanation": "The correct answer is B because a Knowledge-based Agentforce Data Library is the correct managed source for approved service and compliance content. Salesforce Knowledge already handles the article lifecycle, including publication state and article governance, while Agentforce Data Library makes that content searchable for AI grounding. Filtering to published articles prevents draft, archived, or outdated content from being used in customer-facing responses. Option A adds unnecessary Flow- based retrieval and bypasses the native semantic retrieval pattern. Option C may work for custom indexed content, but it is less efficient when the authoritative source is already Salesforce Knowledge. The clean architecture is to connect the data library to Knowledge, restrict the indexed scope, and allow the agent to retrieve semantically relevant approved articles.",
    "section": "data"
  },
  {
    "id": 149,
    "text": "Universal Containers is auditing its AI architecture and needs to ensure that its developers are restricted to using only specifically approved large language models. How should an Agentforce Specialist manage and prevent unapproved models from being accessed across the organization?",
    "options": [
      {
        "letter": "A",
        "text": "Apply an Attribute-Based Access Control policy within the Einstein Trust Layer to block prompts from routing to unapproved large language models"
      },
      {
        "letter": "B",
        "text": "Write a strict system instruction within Agent Builder stating, \"Never use external models for reasoning\""
      },
      {
        "letter": "C",
        "text": "Ensure only approved large language models are enabled in the Model Provider section under Einstein Setup"
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 150,
    "text": "Universal Containers wants support agents to use Agentforce to ask questions about its product tutorials and product guides. What should the Agentforce Specialist do to meet this requirement?",
    "options": [
      {
        "letter": "A",
        "text": "Create a prompt template for product tutorials and guides."
      },
      {
        "letter": "B",
        "text": "Add an Answer Questions custom field in the product object for tutorial instructions."
      },
      {
        "letter": "C",
        "text": "Publish product tutorials and guides as Knowledge articles."
      }
    ],
    "answer": [
      "C"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "B",
        "text": "Export agent components as JSON files and manually import them inte production using the Metadata API."
      },
      {
        "letter": "C",
  ...
  {
    "id": 152,
    "text": "Universal Containers (UC) needs to create a custom prompt template that can be called from a Lightning web component. Which prompt template type should UC create?",
    "options": [
      {
        "letter": "A",
        "text": "Field Generation"
  ...
  {
    "id": 153,
    "text": "Northern Trail Outfitters (NTO) wants to configure Einstein Trust Layer in its production org but is unable to see the option on the Setup page. After provisioning Data Cloud, which step must an Al Specialist take to make this option available to NTO?",
    "options": [
      {
        "letter": "A",
        "text": "Turn on Agent."
      ...
      {
        "letter": "B",
        "text": "Turn on Einstein Generative AI."
      },
      {
        "letter": "C",
        "text": "Turn on Prompt Builder."
      }
    ],
    "answer": [
      "B"
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "Turn on Service AI Grounding, Grounding with Case, and Service Replies."
      },
      {
        "letter": "B",
        "text": "Turn on Service Replies, Service AI Grounding, and Grounding with Knowledge."
      },
      {
        "letter": "C",
        "text": "Turn on Service AI Grounding and Grounding with Knowledge."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 157,
    "text": "Universal Containers implemented Agent for its users. One user complains that Agent is not deleting activities from the past 7 days. What is the reason for this issue?",
    "options": [
      {
        "letter": "A",
        "text": "Agent Delete Record Action permission is not associated to the user."
      },
      {
        "letter": "B",
        "text": "Agent does not have the permission to delete the user's records."
      },
      {
        "letter": "C",
        "text": "Agent does not support the Delete Record action."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 158,
    "text": "Universal Containers wants to use an Al agent to answer questions about warranties, Warranty information has already been uploaded as unstructured data in Data Cloud. When answering user questions, the results must be filterable by product line and ranked by recent updates. Which approach should the Agentforce Specialist implement?",
    "options": [
      {
        "letter": "A",
        "text": "Use the default retriever which automatically accounts for regency ranking."
      },
      {
        "letter": "B",
        "text": "Build a custom retriever in Einstein Studio with product line filters and regency ranking."
      },
      {
        "letter": "C",
        "text": "Apply semantic embeddings with default metadata filters to achieve the desired result"
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 159,
    "text": "Universal Containers plans to enable Agentforce in Slack so teams can interact with agents directly in Slack channels. Which description represents the key steps required to enable Agentforce in Slack?",
    "options": [
      {
        "letter": "A",
        "text": "Enable the default Slack channel Agentforce, and assign Slack agent access to users."
      },
      {
        "letter": "B",
        "text": "Configure the Slack workflow to invoke the Agentforce API, enabling users to interact with agents through predefined triggers and automated steps,"
      },
      {
        "letter": "C",
        "text": "Configure the Slack agent connection and, in Manage Agentforce, install the agent, then assign agent access to users."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 164,
    "text": "How does Agentforce select the correct action to resolve a user's request?",
    "options": [
      {
        "letter": "A",
  ...
  {
    "id": 165,
    "text": "Universal Containers is using Agentforce for Sales to find similar opportunities to help close deals faster. The team wants to understand the criteria used by the Agent to match opportunities. What is one criterion that Agentforce for Sales uses to match similar opportunities?",
    "options": [
      {
        "letter": "A",
        "text": "Matched opportunities have a status of Closed Won from the last 12 months."
      },
      {
        "letter": "B",
        "text": "Matched opportunities are limited to the same account."
      },
      {
        "letter": "C",
        "text": "Matched opportunities were created in the last 12 months."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 166,
    "text": "An Agentforce is creating a custom action for Agentforce. Which setting should the a ensure the action performs as expected?",
    "options": [
      {
        "letter": "A",
        "text": "Action Name"
  ...
  {
    "id": 167,
    "text": "What considerations should an Agentforce Specialist be aware of when using Record Snapshots grounding in a prompt template?",
    "options": [
      {
        "letter": "A",
        "text": "Activities such as tasks and events are excluded."
      },
      {
        "letter": "B",
        "text": "Empty data, such as fields without values or sections without limits, is filtered out."
      },
      {
        "letter": "C",
        "text": "Email addresses associated with the object are excluded."
      }
    ],
    "answer": [
      "A"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "B",
        "text": "Define the desired output structure with explicit headings in the instruction."
      },
      {
        "letter": "C",
        "text": "Use a prompt template-triggered flow to format responses."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 169,
    "text": "Based on the user utterance, ' Show me all the customers in New York ', which standard Agent action will the planner service use?",
    "options": [
      {
        "letter": "A",
        "text": "Query Records"
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "The variable defaults to mutable; the mutable keyword is optional and has no effect, allowing the agent to successfully update the variable."
      },
      {
        "letter": "B",
        "text": "The declaration is a syntax error and the agent will fail to deploy."
      },
      {
        "letter": "C",
        "text": "The variable is treated as read-only; it cannot be updated by actions or @utils.setVariables at runtime because it lacks the mutable keyword."
      }
    ],
    "answer": [
      "C"
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "Role, Task, LLM Clarity Score, and Format"
      },
      {
        "letter": "B",
        "text": "Role, Task, Token Size Limit, and Format"
      },
      {
        "letter": "C",
        "text": "Task, Context, Constraints, and Format"
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 172,
    "text": "Cloud Kicks wants its Agentforce Service Agent to retrieve up-to-date factual data from the internet. Which step must an Agentforce Specialist take to ensure the agent uses the web search capability properly?",
    "options": [
      {
        "letter": "A",
        "text": "Enable the Answer Questions with Knowledge standard action specifically on the General FAQ subagent."
      },
      {
        "letter": "B",
        "text": "Map the web search retriever to a custom search index in Data 360 before activating the agent."
      },
      {
        "letter": "C",
        "text": "Remove the default General FAQ subagent and replace its function with a new General Web Search subagent."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 173,
    "text": "An Agentforce Specialist is trying to troubleshoot a reported issue from an end user, and they do not see the session in the Processed Sessions tab of Agentforce Observability. What should the specialist take into consideration?",
    "options": [
      {
        "letter": "A",
        "text": "The agent has not yet been registered in the Observability app, so no sessions are processed."
      },
      {
        "letter": "B",
        "text": "The session is queued to be processed and can be viewed on the Unprocessed Sessions tab."
      },
      {
        "letter": "C",
        "text": "Sessions are batched on a 24-hour rolling process, and the logs must be checked again the next day."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 175,
    "text": "An Agentforce at Universal Containers is trying to set up a new Field Generation prompt template. They take the following steps. 1. Create a new Field Generation prompt template. 2. Choose Case as the object type. 3. Select the custom field AI_Analysis_c as the target field. After creating the prompt template, the Agentforce Specialist saves, tests, and activates it. Howsoever, when they go to a case record, the AI Analysis field does not show the (Sparkle) icon on the Edit pencil. When the Agentforce Specialist was editing the field, it was behaving as a normal field. Which critical step did the Agentforce Specialist miss?",
    "options": [
      {
        "letter": "A",
        "text": "They forgot to reactivate the Lightning page layout for the Case object after activating their Field Generation prompt template."
      },
      {
        "letter": "B",
        "text": "They forgot that the Case Object is not supported for Add generation as Feinstein Service Replies should be used instead."
      },
      {
        "letter": "C",
        "text": "They forgot to edit the Lightning page layout and associate the field to a prompt template"
      }
    ],
    "answer": [
      "C"
    ...
    "multi": false,
    "explanation": "For Field Generation prompt templates to display the Sparkle icon (indicating AIgenerated content), the target field must be explicitly associated with the prompt template on the Lightning page layout. Even if the prompt template is activated, failing to add the field to the page layout and link it to the template will result in the field behaving as a standard field. Salesforce documentation emphasizes that page layout configuration is mandatory to enable AI-driven field interactions. Reactivating the layout (A) is unnecessary unless the layout itself was modified after activation. Case objects are supported for Field Generation (B is incorrect).",
    "section": "prompt"
  },
  {
    "id": 176,
    "text": "Universal Containers wants to implement a customer verification process where sensitive account information can only be accessed after the customer passes identity verification. The agent must enforce this security rule deterministically without allowing the large language model (LLM) to bypass the verification requirement. What should an Agentforce Specialist recommend as the best solution?",
    "options": [
      {
        "letter": "A",
        "text": "Use context variables to store verification status in the messaging session and configure the agent to check these variables through natural language prompts during each sensitive action."
      },
      {
        "letter": "B",
        "text": "Include detailed verification instructions in the agent's topic instructions explaining when customers should be verified and rely on the LLM to follow these guidelines consistently across all interactions."
      },
      {
        "letter": "C",
        "text": "Create a custom variable IsCustomerVerified set by a verification action, then apply a conditional filter using the expression IsCustomerVerified equals true to all sensitive data actions, ensuring deterministic access control that the LLM can't alter."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 177,
    "text": "An Agentforce is creating a custom action in Agent. Which option is available for the Agentforce Specialist to choose for the custom copilot action?",
    "options": [
      {
        "letter": "A",
        "text": "Apex trigger"
  ...
  {
    "id": 178,
    "text": "What is best practice when refining Agent custom action instructions?",
    "options": [
      {
        "letter": "A",
        "text": "Provide examples of user messages that are expected to trigger the action."
      },
      {
        "letter": "B",
        "text": "Use consistent introductory phrases and verbs across multiple action instructions."
      },
      {
        "letter": "C",
        "text": "Specify the persona who will request the action."
      }
    ],
    "answer": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "Masked data will be de-masked during response journey."
      },
      {
        "letter": "B",
        "text": "Masked data will be de-masked during request journey."
      },
      {
        "letter": "C",
        "text": "Responses that do not meet the relevance threshold will be automatically rejected."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 180,
    "text": "What is a valid option for Omni-Channel routing for a messaging channel?",
    "options": [
      {
        "letter": "A",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "B",
        "text": "Einstein Sales Summaries"
      },
      {
        "letter": "C",
        "text": "Einstein Work Summaries"
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 182,
    "text": "Universal Containers (UC) implements a custom retriever to improve the accuracy of AI- generated responses. UC notices that the retriever is returning too many irrelevant results, making the responses less useful. What should UC do to ensure only relevant data is retrieved?",
    "options": [
      {
        "letter": "A",
        "text": "Define filters to narrow the search results based on specific conditions."
      },
      {
        "letter": "B",
        "text": "Change the search index to a different data model object (DMO)."
      },
      {
        "letter": "C",
        "text": "Increase the maximum number of results returned to capture a broader dataset."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 183,
    "text": "Universal Containers (UC) wants its AI agent to return responses quickly. UC needs to optimize the retriever's configuration to ensure minimal latency when grounding AI responses. Which configuration aspect should UC prioritize?",
    "options": [
      {
        "letter": "A",
        "text": "Configure the retriever to operate in dynamic mode so that it modifies the search Index structure at runtime."
      },
      {
        "letter": "B",
        "text": "Ensure the retriever's filters are defined to limit the scope of each search efficiently."
      },
      {
        "letter": "C",
        "text": "Increase the recency bias setting for the retriever limiting scope to more recent data."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 184,
    "text": "What is the primary function of the reasoning engine in Agentforce?",
    "options": [
      {
        "letter": "A",
        "text": "Identifying agent topics and actions to respond to user utterances"
      },
      {
        "letter": "B",
        "text": "Offering real-time natural language response during conversations"
      },
      {
        "letter": "C",
        "text": "Generating record queries based on conversation history"
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 185,
    "text": "Universal Containers wants to systematically validate agent responses before deployment using a scalable testing process. Which Testing Center approach should the company implement?",
    "options": [
      {
        "letter": "A",
        "text": "Upload a structured CSV test template and run batch test cases in Testing Center."
      },
      {
        "letter": "B",
        "text": "Manually interact with the agent in Builder until responses seem correct."
      },
      {
        "letter": "C",
        "text": "Use pilot users in production to flag incorrect responses post-launch."
      }
    ],
    "answer": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "Agent Action: Find Similar Opportunities"
      },
      {
        "letter": "B",
        "text": "Agent Action: Draft or Revise Sales Email"
      },
      {
        "letter": "C",
        "text": "Agent Action: Summarize Record"
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 187,
    "text": "Cloud Kicks has long, complex legal agreements. An Agentforce agent must be able to retrieve specific clauses that are often nested within larger sections. The standard chunking method is failing to capture the full context of these clauses. Which chunking strategy should an administrator use to preserve the structure of the documents?",
    "options": [
      {
        "letter": "A",
        "text": "Implement a smaller chunk size."
      },
      {
        "letter": "B",
        "text": "Implement a larger chunk size."
      },
      {
        "letter": "C",
        "text": "Implement a keyword-based chunking strategy."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 188,
    "text": "An Agentforce turned on Einstein Generative AI in Setup. Now, the Agentforce Specialist would like to create custom prompt templates in Prompt Builder. However, they cannot access Prompt Builder in the Setup menu. What is causing the problem?",
    "options": [
      {
        "letter": "A",
        "text": "The Prompt Template User permission set was not assigned correctly."
      },
      {
        "letter": "B",
        "text": "The Prompt Template Manager permission set was not assigned correctly."
      },
      {
        "letter": "C",
        "text": "The large language model (LLM) was not configured correctly in Data Cloud."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 192,
    "text": "Universal Containers wants to incorporate the current order fulfillment status into a prompt for a large language model (LLM). The order status is stored in the external enterprise resource planning (ERP) system. Which data grounding technique should the Agentforce Specialist recommend?",
    "options": [
      {
        "letter": "A",
        "text": "Eternal Object Record Merge Fields"
      },
      {
        "letter": "B",
  ...
  {
    "id": 193,
    "text": "Universal Containers (UC) plans to send one of three different emails to its customers based on the customer's lifetime value score and their market segment. Considering that UC are required to explain why an e-mail was selected, which AI model should UC use to achieve this?",
    "options": [
      {
        "letter": "A",
        "text": "Predictive model and generative model"
      },
      {
        "letter": "B",
    ...
    "multi": false,
    "explanation": "Universal Containers should use a Predictive model to decide which of the three emails to send based on the customer's lifetime value score and market segment. Predictive models analyze data to forecast outcomes, and in this case, it would predict the most appropriate email to send based on customer attributes. Additionally, predictive models can provide explainability to show why a certain email was chosen, which is crucial for UC's requirement to explain the decisionmaking process. Generative models are typically used for content creation, not decision-making, and thus wouldn't be suitable for this requirement. Predictive models offer the ability to explain why a particular decision was made, which aligns with UC's needs.",
    "section": "agents"
  },
  {
    "id": 194,
    "text": "Universal Containers' Agent Action includes several Apex classes for the new Agentforce Agent. What is an important consideration when deploying Apex that is invoked by an Agent Action?",
    "options": [
      {
        "letter": "A",
        "text": "The Apex classes must have at least 75% code coverage from unit tests, and all dependencies must be in the deployment package."
      },
      {
        "letter": "B",
        "text": "Apex classes invoked by an Agent Action may be deployed with less than 75% test coverage as long as the agent is not activated in production."
      },
      {
        "letter": "C",
        "text": "The Apex classes may bypass the 75% code coverage requirement as long as they are only used by the agent."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 195,
    "text": "Universal Containers has built a Service Agent for its hospitality brand grounded on a Knowledge data library containing 200 FAQ articles covering reservations, amenities, and cancellation policies. The project team estimates that manually authoring test cases to achieve adequate knowledge coverage would take three weeks. A junior administrator proposes that Testing Center can significantly accelerate this process. Which step should an Agentforce Specialist take to generate a comprehensive initial test suite without manual authoring of individual test cases?",
    "options": [
      {
        "letter": "A",
        "text": "Upload test cases."
      },
      {
        "letter": "B",
        "text": "Generate test cases based on the knowledge available to the agent."
      },
      {
        "letter": "C",
        "text": "Generate test cases based on subagents and actions."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 196,
    "text": "Universal Containers' Service Agent executes a flow action to retrieve Opportunity records. The Opportunity object has an organization-wide default of Private. The agent returns no results despite matching records existing and the flow logic being correctly configured. Which resolution strictly adheres to the principle of least privilege?",
    "options": [
      {
        "letter": "A",
        "text": "Add the required object permissions to the Einstein Service Agent User's permission set and configure appropriate sharing rules"
      },
      {
        "letter": "B",
        "text": "Set the agent action flow to run in System Mode without sharing"
      },
      {
        "letter": "C",
        "text": "Change the Opportunity object's organization-wide default to Public Read Only so the Einstein Service Agent User can access records"
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 197,
    "text": "Universal Containers (UC) plans to automatically populate the Description field on the Account object. Which type of prompt template should UC use?",
    "options": [
      {
        "letter": "A",
        "text": "Field Generation prompt template"
      },
      {
        "letter": "B",
      ...
      {
        "letter": "C",
        "text": "Sales Email prompt template"
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 198,
    "text": "In addition to Recipient and Sender, which object should An Agentforce utilize for inserting merge fields into a Sales email template prompt?",
    "options": [
      {
        "letter": "A",
        "text": "Recipient Opportunities"
      },
      {
        "letter": "B",
  ...
  {
    "id": 199,
    "text": "During configuration, Universal Containers (UC) forgot to grant Knowledge access to the Agentforce Service Agent. Which permission must UC add for the agent to interact with Knowledge articles and answer customer questions effectively?",
    "options": [
      {
        "letter": "A",
        "text": "Allow View Knowledge and Run Flows"
      },
      {
        "letter": "B",
        "text": "Access Knowledge records and fields, and Allow View Knowledge"
      },
      {
        "letter": "C",
        "text": "Access Custom Objects and Manage External Users"
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 201,
    "text": "Which element should an Agentforce Specialist use in an Omni-Flow to route conversations to an agent?",
    "options": [
      {
        "letter": "A",
  ...
  {
    "id": 202,
    "text": "A business stakeholder wants to use Al to generate a summary based on Data Cloud data. Which method(s) should the stakeholder use to access Data Cloud data from Prompt Builder?",
    "options": [
      {
        "letter": "A",
        "text": "Accessing data model objects (DMQs) directly in Flex templates, using Data Cloud related lists, and fetching Data Cloud data using prompt-initiated flows"
      },
      {
        "letter": "B",
        "text": "Using Data Cloud related lists and fetching Data Cloud data using promptinitiated flows"
      },
      {
        "letter": "C",
        "text": "Using only external APIs to import Data Cloud data into Prompt Builder"
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 205,
    "text": "Universal Containers recently added a custom flow for processing returns and created a new Agent Action. Which action should the company take to ensure the Agentforce Service Agent can run this new flow as part of the new Agent Action?",
    "options": [
      {
        "letter": "A",
        "text": "Recreate the flow using the Agentforce agent user."
      },
      {
        "letter": "B",
        "text": "Assign the Manage Users permission to the Agentforce Agent user."
      },
      {
        "letter": "C",
        "text": "Assign the Run Flows permission to the Agentforce Agent user."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 206,
    "text": "An Agentforce at Universal Containers is working on a prompt template to generate personalized emails for product demonstration requests from customers. It is important for the Al- generated email to adhere strictly to the guidelines, using only associated opportunity information, and to encourage the recipient to take the desired action. How should the Agentforce Specialist include these instructions on a new line in the prompt template?",
    "options": [
      {
        "letter": "A",
        "text": "Surround them with triple quotes (\" \" \")."
      },
      {
        "letter": "B",
        "text": "Make sure merged fields are defined."
      },
      {
        "letter": "C",
        "text": "Use curly brackets {} to encapsulate instructions."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 207,
    "text": "An Agentforce Specialist is assisting Universal Containers with troubleshooting an agent. The Agentforce Specialist notices that the agent is not using topic actions in the desired sequence, causing inconsistent outcomes. Which technique should the Agentforce Specialist recommend to ensure deterministic control over the order in which actions are executed?",
    "options": [
      {
        "letter": "A",
        "text": "Specify the large language model (LLM) provider and version."
      },
      {
        "letter": "B",
        "text": "Specify custom variables and filters."
      },
      {
        "letter": "C",
        "text": "Specify the order of actions."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 210,
    "text": "Universal Containers (UC) has implemented Generative AI within Salesforce to enable summarization of a custom object called Guest. Users have reported mismatches in the generated information. In refining its prompt design strategy, which key practices should UC prioritize?",
    "options": [
      {
        "letter": "A",
        "text": "Enable prompt test mode, allocate different prompt variations to a subset of users for evaluation, and standardize the most effective model based on performance feedback."
      },
      {
        "letter": "B",
        "text": "Create concise, clear, and consistent prompt templates with effective grounding, contextual role- playing, clear instructions, and iterative feedback."
      },
      {
        "letter": "C",
        "text": "Submit a prompt review case to Salesforce and conduct thorough testing In the playground to refine outputs until they meet user expectations."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 211,
    "text": "A sales manager is using Agent Assistant to streamline their daily tasks. They ask the agent to Show me a list of my open opportunities. How does the large language model (LLM) in Agentforce identify and execute the action to show the sales manager a list of open opportunities?",
    "options": [
      {
        "letter": "A",
        "text": "The LLM interprets the user's request, generates a plan by identifying the apcMopnete topics and actions, and executes the actions to retrieve and display the open opportunities"
      },
      {
        "letter": "B",
        "text": "The LLM uses a static set of rules to match the user's request with predefined topics and actions, bypassing the need for dynamic interpretation and planning."
      },
      {
        "letter": "C",
        "text": "Using a dialog pattern. the LLM matches the user query to the available topic, action and steps thenperforms the steps for each action, such as retrieving a fast of open opportunities."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 213,
    "text": "An Agentforce Specialist is working declaratively on version 4 of a prompt template, which is significantly different than the previous version 3. A bug is then identified in version 3 and requires a hotfix to be deployed to production immediately by another team. The team will deploy this change as a new version. What should the specialist do to ensure that their work on the latest version is not lost and does not conflict with the new version?",
    "options": [
      {
        "letter": "A",
        "text": "Create a new prompt template with the bug fix, update all references to the new version, and delete the old prompt template."
      },
      {
        "letter": "B",
        "text": "Save their work in version 4, and allow the template to be deployed with a new version 5 containing the fix."
      },
      {
        "letter": "C",
        "text": "Copy and paste version 4 into a backup file or version-control alternative, and allow the other team to overwrite the contents of version 4 with the bug-fixed version."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 214,
    "text": "Universal Containers (UC) has a Flex prompt template that has been used for the last three months to answer questions based on user input. Now, UC wants to give a PDF as a second input. What is the best approach for the Agentforce Specialist to meet this requirement?",
    "options": [
      {
        "letter": "A",
        "text": "Reindex in order to add a new resource to an existing template."
      },
      {
        "letter": "B",
        "text": "Add a resource anytime by navigating to the Resources section and configuring inputs."
      },
      {
        "letter": "C",
        "text": "Discard the current Flex template and create a new one with a resource."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 215,
    "text": "When configuring a file upload-based Data Library, what are the maximum allowed file sizes for text or HTML files and PDF files, respectively?",
    "options": [
      {
        "letter": "A",
        "text": "Up to 100 MB for text or HTML files and up to 4 MB for PDF files"
      },
      {
        "letter": "B",
        "text": "Up to 50 MB for both text or HTML files and PDF files"
      },
      {
        "letter": "C",
        "text": "Up to 4 MB for text or HTML files and up to 100 MB for PDF files"
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 216,
    "text": "How should an organization use the Einstein Trust layer to audit, track, and view masked data?",
    "options": [
      {
        "letter": "A",
        "text": "Utilize the audit trail that captures and stores all LLM submitted prompts in Data Cloud."
      },
      {
        "letter": "B",
        "text": "In Setup, use Prompt Builder to send a prompt to the LLM requesting for the masked data."
      },
      {
        "letter": "C",
        "text": "Access the audit trail in Setup and export all user-generated prompts."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 218,
    "text": "An Agentforce created a custom Agent action, but it is not being picked up by the planner service in the correct order. Which adjustment should the Al Specialist make in the custom Agent action instructions for the planner service to work as expected?",
    "options": [
      {
        "letter": "A",
        "text": "Specify the dependent actions with the reference to the action API name."
      },
      {
        "letter": "B",
        "text": "Specify the profiles or custom permissions allowed to invoke the action."
      },
      {
        "letter": "C",
        "text": "Specify the LLM model provider and version to be used to invoke the action."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 219,
    "text": "What is one key purpose of action instructions when creating a custom agent action in Agentforce?",
    "options": [
      {
        "letter": "A",
        "text": "Action instructions help the reasoning engine decide which action to use."
      },
      {
        "letter": "B",
        "text": "Action instructions define the temperature of the large language model (LLM) powering the Reasoning Engine."
      },
      {
        "letter": "C",
        "text": "Action instructions tell the user how to call this action in a conversation."
  ...
  {
    "id": 220,
    "text": "Universal Containers' Agentforce Specialist suspects the Service Agent is systematically misclassifying billing dispute intents under a general inquiry topic, causing incorrect actions to execute. The administrator needs to identify this pattern across sessions without reviewing individual transcripts. What should the specialist recommend?",
    "options": [
      {
        "letter": "A",
        "text": "Enable Session Tracing in Agentforce Observability and query the Data 360 Session Tracing Data Model directly"
      },
      {
        "letter": "B",
        "text": "Use Agent Optimization in Agentforce Studio, which segments production sessions into moments and generates system intent clusters weekly from crosssession analysis"
      },
      {
        "letter": "C",
        "text": "Upload a representative set of billing dispute utterances to the Agentforce Testing Center and run a batch test comparing expected versus actual topic classifications to identify the scope of the misclassification pattern across production intents"
      }
    ],
    "answer": [
      "B"
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "Execute tasks based on available actions, answering questions using information from accessible Knowledge articles."
      },
      {
        "letter": "B",
        "text": "Invoke a flow which makes a call to external data to create a Knowledge article."
      },
      {
        "letter": "C",
        "text": "Generate a Knowledge article based off the prompts that the agent enters to create steps to cancel flights."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 222,
    "text": "Coral Cloud Resorts is implementing Agentforce retrieval. Customers sometimes type ambiguous terms (for example, \"package\" could mean vacation package or baggage). Which retrieval strategy best balances precision and contextual disambiguation?",
    "options": [
      {
        "letter": "A",
  ...
  {
    "id": 223,
    "text": "Universal Containers (UC) has built a custom retriever in AI Models, formerly Einstein Studio, to ground AI responses with technical documentation. UC now requires that a summary field from the search index be included in the output to provide a brief overview of each retrieved document. What is the recommended course of action for UC?",
    "options": [
      {
        "letter": "A",
        "text": "Create a completely new custom retriever with an entirely revised configuration that incorporates the summary field, and delete the current retriever. Editing the existing retriever is not possible."
      },
      {
        "letter": "B",
        "text": "Edit the existing retriever version to add the summary field to the list of fields returned by the retriever, save the changes, and activate the new version so that prompt templates use the updated configuration."
      },
      {
        "letter": "C",
        "text": "Use only the default retriever, which will automatically include all available fields from the search index, including the summary field, without any need to create or manage custom retrievers."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 224,
    "text": "A customer is authenticated and identified as being either bronze, silver, or gold membership level. Those levels define which subagents or actions are available to the agent to perform specific tasks as per the level- based entitlements. What is the best way to ensure the agent responds appropriately?",
    "options": [
      {
        "letter": "A",
        "text": "Use before reasoning to set custom variables that will be used in filters and flow logic."
      },
      {
        "letter": "B",
        "text": "Use after reasoning to set custom variables that will be used in filters and flow logic."
      },
      {
        "letter": "C",
        "text": "Use Agent Router to set custom variables that will be used in filters and flow logic."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 225,
    "text": "Universal Containers (UC) has configured a data library and wants to restrict indexing of knowledge articles to articles which are only publicly available in their knowledge base, UC also wants the agent to link sources that the large language model (LLM) grounded its response on. Which settings should help UC with this?",
    "options": [
      {
        "letter": "A",
        "text": "In the data library setting window, under Knowledge Settings, enable Use Public Knowledge Article and select Show sources,"
      },
      {
        "letter": "B",
        "text": "In the data library setting window, under Knowledge Settings, enable Use Public Knowledge Article. It is not possible to display articles that the LLM grounded its response in."
      },
      {
        "letter": "C",
        "text": "Use Data Categories to categorize publicly available articles to index. Sources are automatically displayed when knowledge articles are categorized as Public."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 227,
    "text": "Universal Containers (UC) wants to ensure its compliance team can retrieve exact matches of policy clause numbers from a structured legal document library. Which search type should UC implement?",
    "options": [
      {
        "letter": "A",
        "text": "Use keyword search for exact term matching on structured fields like clause numbers."
      },
      {
        "letter": "B",
        "text": "Use hybrid search to blend keyword and semantic recall."
      },
      {
        "letter": "C",
        "text": "Use semantic search to interpret synonyms of clauses dynamically."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 228,
    "text": "A customer wants to analyze complete agent interactions, from the initial user request through to the final resolution, to better understand agent behavior and response quality. Which Agentforce feature should an Agentforce Specialist recommend?",
    "options": [
      {
        "letter": "A",
  ...
  {
    "id": 229,
    "text": "Universal Containers recently deployed a customer service agent to handle common inquiries. After a month of usage, the support manager wants to analyze the agent's performance. They need to view aggregated metrics such as the escalation rate to human agents, average session duration, and which topics have the lowest resolution scores so they can prioritize which agent actions need optimization. Which native Salesforce capability should the Agentforce Specialist use to provide these insights and guide the optimization strategy?",
    "options": [
      {
        "letter": "A",
        "text": "Agentforce Observability, leveraging Agent Analytics dashboards and the Session Tracing Data Model to review aggregate performance and drill into specific underperforming interactions."
      },
      {
        "letter": "B",
        "text": "The Einstein Trust Layer Audit Trail, exporting the raw JSON logs to measure the token usage and temperature settings of every user session."
      },
      {
        "letter": "C",
        "text": "The Salesforce Optimization report, scheduling a monthly scan to identify deprecated subagents and unused agent actions across the org."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 230,
    "text": "Universal Containers wants to automatically populate the Description field on the Account object.",
    "options": [
      {
        "letter": "A",
        "text": "Sales Email"
  ...
  {
    "id": 231,
    "text": "Universal Containers (UC) wants to implement an AI-powered customer service agent that can: Retrieve proprietary policy documents that are stored as PDFs. Ensure responses are grounded in approved company data, not generic LLM knowledge.What should UC do first?",
    "options": [
      {
        "letter": "A",
  ...
  {
    "id": 232,
    "text": "Cloud Kicks wants to integrate its agent with its custom website. The goal is for customers to interact with the custom agent chat interface. Which approach provides the framework for the custom web application to communicate with the agent?",
    "options": [
      {
        "letter": "A",
        "text": "Agent-to-Agent (A2A)"
  ...
  {
    "id": 233,
    "text": "Universal Containers has PDF maintenance guides in an external folder, not yet in Salesforce. The team wants a standard, clicks- only setup for the Service Agent to use these documents. Which approach should the Agentforce Specialist implement?",
    "options": [
      {
        "letter": "A",
        "text": "Paste external PDF links into topic instructions and rely on the model to follow them, avoiding configuration of a retrieval source, index, or retriever action."
      },
      {
        "letter": "B",
    ...
    "multi": false,
    "explanation": "According to the AgentForce Data Library and Retrieval Configuration Guide, when organizations have external PDF or text documents that need to be used by an AI agent, the recommended clicks- only approach is to upload the documents as a File Source in the AgentForce Data Library. The system automatically processes the uploaded files, chunks their content, builds a Search Index, and allows you to create a retriever to ground agent responses from those indexed documents. This method requires no code or manual integration and ensures that all document content becomes queryable through retrieval-augmented generation (RAG). Option A is incorrect because LLMs cannot reliably access external links; they require indexed data. Option C, involving Data Cloud ingestion, is a more advanced, developer-level approach-not a clicks- only setup. Hence, the correct implementation is Option B - Upload PDFs as File Source in the AgentForce Data Library and create a retriever for grounding.",
    "section": "data"
  },
  {
    "id": 234,
    "text": "Ursa Major Solar is developing a help agent that must answer customer questions by grounding prompts in data from both internal Knowledge articles and an external partner portal. The Agentforce Specialist configures the agent to use a Data 360 search index. During testing in Agentforce Builder, the agent occasionally provides conflicting answers, and the specialist needs to differentiate between these two grounding sources to troubleshoot the responses. Which Data 360 process should the specialist review to ensure the origin of the information is accurately identified and made available?",
    "options": [
      {
        "letter": "A",
        "text": "The data harmonization process, where raw data is mapped to data model objects and source metadata is standardized to be queried specifically by hybrid retrievers."
      },
      {
        "letter": "B",
        "text": "The Retrieval-Augmented Generation synthesis phase, where the large language model automatically uses a semantic retriever to append the source system tag to the final generated output."
      },
      {
        "letter": "C",
        "text": "The Data 360 retriever function process, where retrieved content can be filtered based on source metadata, such as document type or author, to refine results before they are ranked using semantic or hybrid search."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 235,
    "text": "Northern Trail Outfitters is testing an agent connected to an Agentforce Data Library. The agent successfully retrieves the correct data from the library, but delivers the response to the user as raw JSON structures instead of grammatically correct conversational language. Which quality evaluation scores poorly in this scenario?",
    "options": [
      {
        "letter": "A",
        "text": "Coherence"
  ...
  {
    "id": 237,
    "text": "An Agentforce Specialist is building a Flex prompt template. Which best practice should the Agentforce Specialist follow when creating the Flex prompt template?",
    "options": [
      {
        "letter": "A",
  ...
  {
    "id": 238,
    "text": "Universal Containers uses Agentforce to manage its customer service operations. However, the company uses a completely separate, third-party AI agent system to manage its warehouse logistics. UC wants the Agentforce customer service agent to be able to seamlessly request shipping reroutes and collaborate autonomously with the warehouse agent. Which open standard protocol is specifically designed to facilitate this exact type of cross-platform collaboration?",
    "options": [
      {
        "letter": "A",
      ...
      {
        "letter": "B",
        "text": "Advanced Data Retrieval standard"
      },
      {
        "letter": "C",
        "text": "Agent-to-Agent protocol"
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 239,
    "text": "Universal Containers has a custom Agent action calling a flow to retrieve the realtime status of an order from the order fulfillment system. For the given flow, what should the Agentforce Specialist consider about the running user's data access?",
    "options": [
      {
        "letter": "A",
        "text": "The flow must have the \" with sharing \" permission selected m the advanced settings for the permissions, field-level security, and sharing settings to be respected."
      },
      {
        "letter": "B",
        "text": "The custom action adheres to the permissions, held-level security, and sharing settings configured in the flow.. The Agent will always run flows in system mode so the running user's data access will not affect the data returned."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 241,
    "text": "Universal Containers needs to ground a new Agentforce agent with structured data stored in an external system without duplicating it in Data 360. This approach is necessary to ensure real- time data accuracy and minimize storage costs. Which Data 360 concept should the team use to accomplish this?",
    "options": [
      {
        "letter": "A",
        "text": "Establish a semantic index for external content."
      },
      {
        "letter": "B",
        "text": "Utilize Zero Copy to access external data without ingestion."
      },
      {
        "letter": "C",
        "text": "Configure a data stream to import the data into Data 360."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 242,
    "text": "What is the role of the large language model (LLM) in understanding intent and executing an Agent Action?",
    "options": [
      {
        "letter": "A",
        "text": "Find similar requested topics and provide the actions that need to be executed."
      },
      {
        "letter": "B",
        "text": "Identify the best matching topic and actions and correct order of execution."
      },
      {
        "letter": "C",
        "text": "Determine a user's topic access and sort actions by priority to be executed."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 244,
    "text": "Universal Containers (UC) wants to enable its sales team with automatic post-call visibility into mention of competitors, products, and other custom phrases. Which feature should the Agentforce Specialist set up to enable UC's sales team?",
    "options": [
      {
        "letter": "A",
        "text": "Call Summaries"
  ...
  {
    "id": 246,
    "text": "In a Knowledge-based data library, which capability does enabling the \"Filter by Knowledge Data Categories\" option provide?",
    "options": [
      {
        "letter": "A",
        "text": "It applies custom metadata from the selected data categories to the Knowledge articles, aiming to enhance search relevance."
      },
      {
        "letter": "B",
        "text": "It organizes the indexed Knowledge articles into separate sections based on their assigned data categories."
      },
      {
        "letter": "C",
        "text": "It limits the indexed articles to only those belonging to selected data categories, thereby improving indexing precision."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 247,
    "text": "A company wants to retrieve patient history details to augment the Al agent response. [he company wants to leverage the Data Cloud search index feature. What is best practice when considering retrieval-augrmented generation (RAG) for information that may contain personally identifiable information (PII)?",
    "options": [
      {
        "letter": "A",
        "text": "Depend on the agent's prompt to avoid exposing PII."
      },
      {
        "letter": "B",
        "text": "Encrypt embeddings, but still index PII records."
      },
      {
        "letter": "C",
        "text": "Mask sensitive fields and index only non-PII data."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 248,
    "text": "Universal Containers (UC) wants to ensure the effectiveness, reliability, and trust of its agents prior to deploying them in production. UC would like to efficiently test a large and repeatable number of utterances. What should the Agentforce Specialist recommend?",
    "options": [
      {
        "letter": "A",
        "text": "Leverage the Agent Large Language Model (LLM) UI and test UC's agents with different utterances prior to activating the agent."
      },
      {
        "letter": "B",
        "text": "Deploy the agent in a QA sandbox environment and review the Utterance Analysis reports to review effectiveness."
      },
      {
        "letter": "C",
        "text": "Create a CSV file with UC's test cases in Agentforce Testing Center using the testing template."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 250,
    "text": "Coral Cloud Resorts is about to start testing its concierge agent with guests. Which metrics should be captured to monitor the performance, correctness, and user experience?",
    "options": [
      {
        "letter": "A",
        "text": "Agent performance, token usage, and conversation duration"
      },
      {
        "letter": "B",
        "text": "Response performance, tone, and CSATs"
      },
      {
        "letter": "C",
        "text": "Response times, accuracy and relevance of answers, and resolution success"
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 251,
    "text": "Universal Containers (UC) configured a new PDF file ingestion in Data Cloud with all the required fields, and also created the mapping and the search Index. UC Is now setting up the retriever and notices a required fleld is missing. How should UC resolve this?",
    "options": [
      {
        "letter": "A",
        "text": "Create a new custom Data Cloud object that includes the desired field."
      },
      {
        "letter": "B",
        "text": "Update the search index to include the desired field."
      },
      {
        "letter": "C",
        "text": "Modify the retriever's configuration to include the desired field.."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 252,
    "text": "Coral Cloud Resorts needs consistent pass/fail logic for agent testing. Which Testing Center capability provides that?",
    "options": [
      {
        "letter": "A",
        "text": "Use customer rating as a proxy for correctness."
      },
      {
        "letter": "B",
        "text": "Run a script on event logs to identify the failed utterances."
      },
      {
        "letter": "C",
        "text": "Use structured batch testing with validation per test utterance,"
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 253,
    "text": "Universal Containers wants an AI agent to answer questions about warranties using unstructured data stored in Data Cloud. Results must be filterable by product line and ranked by recent updates.",
    "options": [
      {
        "letter": "A",
        "text": "Use the default retriever which automatically accounts for recency ranking."
      },
      {
        "letter": "B",
        "text": "Build a custom retriever in Einstein Studio with product line filters and recency ranking."
      },
      {
        "letter": "C",
        "text": "Apply semantic embeddings with default metadata filters to achieve the desired result."
  ...
  {
    "id": 254,
    "text": "After an agent selects a topic, what is an important factor the reasoning engine uses to select the action?",
    "options": [
      {
        "letter": "A",
        "text": "The priority given to each action"
      },
      {
        "letter": "B",
        "text": "The explicit order of actions in the topic"
      },
      {
        "letter": "C",
        "text": "The name and instructions of the actions"
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 255,
    "text": "Universal Containers (UC) wants to create a new Sales Email prompt template in Prompt Builder using the \" Save As \" function. However, UC notices that the new template produces different results compared to the standard Sales Email prompt due to missing hyperparameters. What should UC do to ensure the new prompt template produces results comparable to the standard Sales Email prompts?",
    "options": [
      {
        "letter": "A",
        "text": "Use Model Playground to create a model configuration with the specified parameters."
      },
      {
        "letter": "B",
        "text": "Manually add the hyperparameters to the new template."
      },
      {
        "letter": "C",
        "text": "Revert to using the standard template without modifications."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 257,
    "text": "Universal Containers (UC) needs to improve the agent productivity in replying to customer chats. Which generative AI feature should help UC address this issue?",
    "options": [
      {
        "letter": "A",
        "text": "Case Summaries"
  ...
  {
    "id": 258,
    "text": "Universal Containers needs to restrict access to refund processing actions so only customers with Active account status can initiate refunds. How should an Agentforce Specialist apply the restriction deterministically?",
    "options": [
      {
        "letter": "A",
        "text": "Create a Flex Prompt Template that has instructions to check for account status."
      },
      {
        "letter": "B",
  ...
  {
    "id": 259,
    "text": "In the context of retriever and search indexes, what best describes the data preparation process in Data Cloud?",
    "options": [
      {
        "letter": "A",
  ...
  {
    "id": 260,
    "text": "Universal Containers has deployed several specialized Agentforce Employee Agents, such as IT Support, HR Assistant, and Procurement, to assist with internal tasks. Recently, UC's help desk has reported a high volume of failed interactions because employees are frequently selecting the incorrect agent to handle their requests, for example, asking the HR Assistant agent to reset a network password. UC wants to improve the user experience, scale their deployment, and centralize control without requiring employees to guess which agent to use. Which architectural approach should the Agentforce Specialist recommend to resolve this issue?",
    "options": [
      {
        "letter": "A",
        "text": "Create a custom validation rule on the Agent Session object to prevent users from submitting prompts that do not match the selected agent's system instructions."
      },
      {
        "letter": "B",
        "text": "Implement a Single Org Multi-Agent (SOMA) to act as a unified, central entry point that interprets user intent and routes the request to the appropriate specialized capabilities."
      },
      {
        "letter": "C",
        "text": "Deploy a standalone Multi-Agent architecture where each specialized agent prompts the user to verify their specific department and role before proceeding with the conversation."
      }
    ],
    "answer": [
      "B"
    ...
    "multi": false,
    "explanation": "The correct answer is B because the problem is not that users need stricter validation; the problem is that users are being forced to choose the right specialized agent themselves. A Single Org Multi- Agent architecture provides a centralized entry point that interprets the employee's intent and routes the request to the correct specialized agent or capability. That removes the guesswork, improves user experience, and scales better as more departmental agents are added. Option A is wrong because validation rules on sessions do not solve intent routing and would create brittle blocking behavior. Option C still leaves routing responsibility distributed across separate agents and adds extra user friction. Salesforce's Multi-Agent Orchestration guidance describes connecting agents with specialized agents to extend capabilities and coordinate work across agents.",
    "section": "multi_agent"
  },
  {
    "id": 261,
    "text": "Which use case is best supported by Salesforce Agent's capabilities?",
    "options": [
      {
        "letter": "A",
        "text": "Bring together a conversational interface for interacting with AI for all Salesforce users, such as developers and ecommerce retailers."
      },
      {
        "letter": "B",
        "text": "Enable Salesforce admin users to create and train custom large language models (LLMs) using CRM data."
      },
      {
        "letter": "C",
        "text": "Enable data scientists to train predictive AI models with historical CRM data using built-in machine learning capabilities"
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 262,
    "text": "Universal Containers wants to ensure that its AI agent's responses consistently reflect the company's unique brand voice and specific quality standards beyond simple pass or fail checks. How should the Agentforce Specialist configure the Testing Center to evaluate this specific criteria?",
    "options": [
      {
        "letter": "A",
        "text": "Enable the Coherence quality evaluation"
      },
      {
        "letter": "B",
        "text": "Use the default Response Evaluation metric"
      },
      {
        "letter": "C",
        "text": "Create a custom evaluation using a large language model judge"
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 263,
    "text": "How does Secure Data Retrieval ensure that only authorized users can access necessary Salesforce data for dynamic grounding?",
    "options": [
      {
        "letter": "A",
        "text": "Retrieves Salesforce data based on the ' Run As \" users permissions."
      },
      {
        "letter": "B",
        "text": "Retrieves Salesforce data based on the user's permissions executing the prompt."
      },
      {
        "letter": "C",
        "text": "Retrieves Salesforces data based on the Prompt template's object permissions."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 264,
    "text": "Universal Containers' current AI data masking rules do not align with organizational privacy and security policies and requirements. What should An Agentforce recommend to resolve the issue?",
    "options": [
      {
        "letter": "A",
        "text": "Enable data masking for sandbox refreshes."
      },
      {
        "letter": "B",
        "text": "Configure data masking in the Einstein Trust Layer setup."
      },
      {
        "letter": "C",
        "text": "Add new data masking rules in LLM setup."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 265,
    "text": "Universal Containers (UC) is rolling out an AI-powered support assistant to help customer service agents quickly retrieve relevant troubleshooting steps and policy guidelines. The assistant relies on a search index in Data Cloud that contains product manuals, policy documents, and past case resolutions. During testing, UC notices that agents are receiving too many irrelevant results from older product versions that no longer apply. How should UC address this issue?",
    "options": [
      {
        "letter": "A",
        "text": "Modify the search index to only store documents from the last year and remove older records."
      },
      {
        "letter": "B",
        "text": "Create a custom retriever in Einstein Studio, and apply filters for publication date and product line."
      },
      {
        "letter": "C",
        "text": "Use the default retriever, as it already searches the entire search index and provides broad coverage."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 266,
    "text": "What is a valid use case for Data Cloud retrievers?",
    "options": [
      {
        "letter": "A",
        "text": "Returning relevant data from the vector database to augment a prompt."
      },
      {
        "letter": "B",
        "text": "Grounding data from external websites to augment a prompt with RAG."
      },
      {
        "letter": "C",
        "text": "Modifying and updating data within the source systems connected to Data Cloud."
      }
    ],
    "answer": [
      "A"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "B",
        "text": "Vector embedding in hybrid search are prefiltered by keyword matches, reducing computational overhead and improving response accuracy."
      },
      {
        "letter": "C",
  ...
  {
    "id": 268,
    "text": "Universal Containers (UC) is preparing to use the Agentforce Testing Center to ensure the reliability of a new agent. UC has a CSV file with test cases and is reviewing the documentation to understand best practices and limitations. Which best practice should the company follow to avoid modifying CRM data while running tests in the Testing Center?",
    "options": [
      {
        "letter": "A",
        "text": "Run tests in the production environment to ensure real-time data accuracy."
      },
      {
        "letter": "B",
        "text": "Limit the number of test cases to 50 per test to minimize data changes."
      },
      {
        "letter": "C",
        "text": "Use the Testing Center only in the sandbox environment."
      }
    ],
    "answer": [
      "C"
  ...
  },
  {
    ...
    "multi": false,
    "explanation": "The AgentForce Retrieval and Semantic Search Guide explains that vector search (semantic search) is best suited for handling spelling variations, synonyms, and phonetically similar queries. The documentation states: \"Vector search enables fuzzy matching through semantic embeddings, allowing retrieval of relevant documents even when user queries contain typos, abbreviations, or informal phrasing.\" Option A (hybrid search) is effective when combining structured and unstructured queries but is not primarily designed to handle spelling tolerance. Option C (keyword search) relies on exact term matching and fails when users misspell words. Therefore, Option B - vector search - is the correct solution for managing misspellings and similar wor d variations. References (AgentForce Documents / Study Guide): AgentForce Semantic Retrieval Guide: \"Handling Misspellings and Synonyms with Vector Search\" AgentForce Data Cloud Search Handbook AgentForce Study Guide: \"Optimizing Retrieval for Typo and Synonym Tolerance\"",
    "section": "data"
  },
  {
    "id": 270,
    "text": "Universal Containers is interested in using Call Explorer to quickly gain insights from meetings recorded by its sales team. What should the Agentforce Specialist be aware of before enabling this feature?",
    "options": [
      {
        "letter": "A",
        "text": "Call Explorer operates independently of Salesforce Knowledge, requiring no prior setup."
      },
      {
        "letter": "B",
        "text": "Custom Call Explorer actions need to be built before it can be configured."
      },
      {
        "letter": "C",
        "text": "Call Explorer requires the Einstein Conversation Insights permission set to be enabled."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 271,
    "text": "Universal Containers wants to leverage the Record Snapshots grounding feature in a prompt template. What preparations are required?",
    "options": [
      {
        "letter": "A",
        "text": "Configure page layout of the master record type."
      },
      {
        "letter": "B",
        "text": "Create a field set for all the fields to be grounded."
      },
      {
        "letter": "C",
        "text": "Enable and configure dynamic form for the object."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 272,
    "text": "An Agentforce Specialist at Universal Containers previously recommended removing superseded mortgage policy documents ingested into Data 360 to prevent the agent retrieving outdated terms. Legal has now confirmed that all historical versions must remain in the system simultaneously, as each version remains contractually binding for customers who signed under it. Which revised recommendation should the specialist make?",
    "options": [
      {
        "letter": "A",
        "text": "Configure a custom retriever in AI Models, formerly Einstein Studio, with a dynamic filter on the policy version metadata field, populated at runtime from the customer's Contract record in CRM, ensuring retrieval is deterministically scoped to the document version applicable to that customer's agreement before similarity ranking is applied."
      },
      {
        "letter": "B",
        "text": "Add the policy version identifier as a prepend field in the search index so every chunk is tagged with its applicable version at indexing time, enabling the large language model (LLM) to identify and select the correct version during response generation."
      },
      {
        "letter": "C",
        "text": "Create a separate data stream for each policy version and configure the agent to query the appropriate unstructured data model object (UDMO) corresponding to the customer's contract date, isolating each version's vectors from the others."
      }
    ],
    "answer": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "Make Less Formal"
      },
      {
        "letter": "B",
        "text": "Enhance Friendliness"
      },
      {
        "letter": "C",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "B",
        "text": "Use well-defined output instructions and provide desired output examples."
      },
      {
        "letter": "C",
  ...
  {
    "id": 275,
    "text": "Universal Containers needs to create Data Cloud reports to understand agent behavior. Which data lake object (DLO) represents an overarching container capturing contiguous interactions with one or more Al agents?",
    "options": [
      {
        "letter": "A",
  ...
  {
    "id": 276,
    "text": "What is the primary advantage of creating an individual retriever instead of the default retriever?",
    "options": [
      {
        "letter": "A",
        "text": "Individual retrievers can aggregate multiple data spaces and data model objects (DMOs) into a unified retriever output."
      },
      {
        "letter": "B",
        "text": "Individual retrievers allow the configuration of filters, specified fields, and how many results are returned."
      },
      {
        "letter": "C",
        "text": "Individual retrievers automatically generate new search indexes and dynamically update vectors."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 277,
    "text": "A company built a custom Apex action invoked by an Employee Agent to fetch data from an external API. The callout method uses the current user's Salesforce session ID to authenticate the callout. The external callout works perfectly in the UI, but silently fails when the agent triggers it. What is the architectural best practice to fix this?",
    "options": [
      {
        "letter": "A",
        "text": "Explicitly extend the Apex class security to the logged-in user's profile."
      },
      {
        "letter": "B",
        "text": "Ensure the Employee Agent is assigned the Agentforce Service Agent User permission set group."
      },
      {
        "letter": "C",
        "text": "Replace the session ID retrieval with a Named Credential."
      }
    ],
    "answer": [
      "C"
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "Product recommendation prediction"
      },
      {
        "letter": "B",
      ...
      {
        "letter": "C",
        "text": "Contract Renewal Date prediction"
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 282,
    "text": "Universal Containers (UC) is looking to improve its sales team's productivity by providing real-time insights and recommendations during customer interactions. Why should UC consider using Agentforce Sales Agent?",
    "options": [
      {
        "letter": "A",
        "text": "To track customer interactions for future analysis"
      },
      {
        "letter": "B",
        "text": "To automate the entire sales process for maximum efficiency"
      },
      {
        "letter": "C",
        "text": "To streamline the sales process and increase conversion rates"
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 284,
    "text": "After configuring and saving a Salesforce Agentforce Data Library (regardless of the data source), which components are automatically created and available in Data Cloud?",
    "options": [
      {
        "letter": "A",
        "text": "A data pipeline, an indexing engine, and a query processor"
      },
      {
        "letter": "B",
        "text": "A data connector, an analytics dashboard, and a workflow rule"
      },
      {
        "letter": "C",
        "text": "A data stream, a search index, and a retriever"
      }
    ],
    "answer": [
      "C"
  ...
  },
  {
    ...
    "multi": false,
    "explanation": "Agentforce Sales Agent is designed to let sales teams perform tasks via natural language commands, leveraging Salesforce data while adhering to policies. For example, agents can ask the AI to \" update the opportunity stage to Closed Won \" or \" generate a quote, \" with the system enforcing validations and data security. This use case aligns with Salesforce's vision of conversational AI streamlining workflows without compromising compliance. Step-by-step guides (B) are typically handled by tools like Dynamic Forms or Guided Selling, not Agentforce. Logging messages/emails (C) is managed by Email-to-Case or Service Cloud, not a salesspecific AI agent.",
    "section": "agents"
  },
  {
    "id": 286,
    "text": "Universal Containers (UC) wants to limit an agent's access to Knowledge articles while deploying the \" Answer Questions with Knowledge \" action. How should UC achieve this?",
    "options": [
      {
        "letter": "A",
        "text": "Define scope instructions to the agent specifying a list of allowed article titles or IDs."
      },
      {
        "letter": "B",
        "text": "Update the Data Library Retriever to filter on a custom field on the Knowledge article."
      },
      {
        "letter": "C",
        "text": "Assign Data Categories to Knowledge articles, and define Data Category filters in the Agentforce Data Library."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 287,
    "text": "Universal Containers wants to utilize Agentforce for Sales to help sales reps reach their sales quotas by providing AI-generated plans containing guidance and steps for closing deals. Which feature meets this requirement?",
    "options": [
      {
        "letter": "A",
        "text": "Create Account Plan"
      },
      {
        "letter": "B",
        "text": "Find Similar Deals"
      },
      {
        "letter": "C",
        "text": "Create Close Plan"
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 292,
    "text": "Sales reps at Universal Containers should not be able to create or edit prompt templates. Which permission set should an AgentForce Specialist assign to the sales reps?",
    "options": [
      {
        "letter": "A",
        "text": "Prompt Execute User"
      },
      {
        "letter": "B",
  ...
  {
    "id": 293,
    "text": "What is the primary function of the planner service in the Agent system?",
    "options": [
      {
        "letter": "A",
        "text": "Generating record queries based on conversation history"
      ...
      {
        "letter": "B",
        "text": "Offering real-time language translation during conversations"
      },
      {
        "letter": "C",
        "text": "Identifying copilot actions to respond to user utterances"
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 294,
    "text": "Universal Containers is configuring a customer service agent and needs to restrict a specific \"Process Refund\" action so that it is only visible to the reasoning engine when a customer's account is flagged as active. An Agentforce Specialist is writing the available when clause in Agent Script to evaluate the @variables.IsActive variable. Which operator should the Agentforce Specialist use for this condition?",
    "options": [
      {
        "letter": "A",
        "text": "The Agentforce Specialist must use the == operator; Agent Script uses == strictly for comparison in conditionals."
      },
      {
        "letter": "B",
        "text": "Both = and == are valid and interchangeable; the Agentforce Specialist can use either operator to evaluate conditional logic in Agent Script."
      },
      {
        "letter": "C",
        "text": "The Agentforce Specialist must use the = operator; Agent Script uses = for both variable assignment and condition comparison."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 295,
    "text": "When creating a custom retriever in Einstein Studio, which step is considered essential?",
    "options": [
      {
        "letter": "A",
        "text": "Select the search index, specify the associated data model object (DMO) and data space, and optionally define filters to narrow search results."
      },
      {
        "letter": "B",
        "text": "Define the output configuration by specifying the maximum number of results to return, and map the output fields that will ground the prompt."
      },
      {
        "letter": "C",
        "text": "Configure the search index, choose vector or hybrid search, choose the fields for filtering, the data space and model, then define the ranking method."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 296,
    "text": "Universal Containers has created an Employee Agent. Which step should an Agentforce Specialist take to connect the agent with a Slack channel?",
    "options": [
      {
        "letter": "A",
        "text": "Create a connection between Salesforce and the Slack workspace."
      },
      {
        "letter": "B",
        "text": "Create an Omni-Channel flow and connection between Salesforce and the Slack workspace."
      },
      {
        "letter": "C",
  ...
  {
    "id": 298,
    "text": "An Agentforce Specialist is evaluating an agent conversation. What is the reason why intents and session metrics within Observability are important to consider?",
    "options": [
      {
        "letter": "A",
        "text": "To evaluate the agent's overall performance"
      },
      {
        "letter": "B",
        "text": "To evaluate why the agent was unable to answer a user's question"
      },
      {
        "letter": "C",
        "text": "To evaluate the deflection rate of the agent"
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 299,
    "text": "Universal Containers needs to provide insights on the usability of Agents to drive adoption in the organization. What should the Agentforce Specialist recommend?",
    "options": [
      {
        "letter": "A",
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "Use Salesforce Flow to guide the large language model in handling order validation and the return process."
      },
      {
        "letter": "B",
        "text": "Use a custom Apex @InvocableMethod to handle the entire return process."
      },
      {
        "letter": "C",
        "text": "Use procedural instructions in Agent Script to enforce the order validation step."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 301,
    "text": "Which configuration must An Agentforce complete for users to access generative Al-enabled fields in the Salesforce mobile app?",
    "options": [
      {
        "letter": "A",
        "text": "Enable Mobile Generative AI."
      },
      {
        "letter": "B",
        "text": "Enable Mobile Prompt Responses."
      },
      {
        "letter": "C",
        "text": "Enable Dynamic Forms on Mobile."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 302,
    "text": "A Service Agent at Universal Containers (UC) is designed to help customers resolve issues by searching against knowledge articles. Knowledge articles have PDF attachments that add critical details. UC reports that the agent provides excellent summaries of the knowledge articles, but seems completely unaware of the PDF attachments. How should an Agentforce Specialist configure the Data Cloud search index to include the content of these attached files?",
    "options": [
      {
        "letter": "A",
        "text": "Increase article chunk size and token limits for Knowledge indexing so larger contexts capture attachment references."
      },
      {
        "letter": "B",
        "text": "Enable ' Include Related Attachments' for Knowledge-- kav and map the ContentDocumentLink unstructured data model object (UDMO)."
      },
      {
        "letter": "C",
        "text": "Use Data Cloud's 'Include Attachments' option and select the ContentDocumentVersion unstructured data model object (UDMO)."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 303,
    "text": "An Agentforce Specialist is creating a prompt template to assist support reps in drafting responses to customer complaints. To ensure the responses are empathetic and helpful, what is a key element to include in the prompt template?",
    "options": [
      {
        "letter": "A",
        "text": "A direct instruction to the large language model (LLM) to role-play as a character"
      },
      {
        "letter": "B",
        "text": "A list of keywords related to customer complaints"
      },
      {
        "letter": "C",
        "text": "The entire history of the customer's previous interactions with the company"
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 305,
    "text": "An Agentforce Specialist is tasked with analyzing Agent interactions, looking into user inputs, requests, and queries to identify patterns and trends. What functionality allows the Agentforce Specialist to achieve this?",
    "options": [
      {
        "letter": "A",
        "text": "Agent Event Logs dashboard."
      },
      {
        "letter": "B",
        "text": "AI Audit and Feedback Data dashboard."
      },
      {
        "letter": "C",
        "text": "User Utterances dashboard."
      }
    ],
    "answer": [
      "C"
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "Depend on Agentforce instructions to enforce warranty constraints and include only WarrantyStatus = Active results."
      },
      {
        "letter": "B",
        "text": "Store the account's warranty status in an Agentforce custom variable to dynamically filter warranties during retrieval."
      },
      {
        "letter": "C",
        "text": "Use Hybrid Search and apply pre-filtering in a new custom retriever for matching accounts and where the WarrantyStatus = Active field,"
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 307,
    "text": "The VP of Service at Universal Containers requires a report showing weekly deflection rate trends and escalation volumes for the Agentforce Service Agent over the past 90 days. Which approach should the Agentforce Specialist recommend?",
    "options": [
      {
        "letter": "A",
        "text": "Enable Agentforce Health Monitoring to configure escalation rate alert thresholds and export the resulting trend data into a Tableau dashboard aligned with the VP of Service's reporting requirement s"
      },
      {
        "letter": "B",
        "text": "Use Agent Analytics within Agentforce Observability, which provides Tableaupowered dashboards with prebuilt deflection rate, escalation volume, and abandonment metrics calculated from agent session data stored in Data 360"
      },
      {
        "letter": "C",
        "text": "Query the OTEL-compliant Session Tracing Data Model in Data 360 using CRM Analytics to build a custom dashboard with deflection rate calculations and week-over-week escalation comparisons tailored to UC's reporting standards"
      }
    ],
    "answer": [
      "B"
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "Save as New Template and edit as needed."
      },
      {
        "letter": "B",
        "text": "Clone the existing template and modify as needed."
      },
      {
        "letter": "C",
        "text": "Save as New Version and edit as needed."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 311,
    "text": "Universal Containers is indexing millions of product manuals where users may ask both structured queries (model numbers) and natural language questions (for example, \"How do I reset my device? \"), Which retrieval approach should the company use?",
    "options": [
      {
        "letter": "A",
        "text": "Use keyword search only, since model numbers dominate queries."
      },
      {
        "letter": "B",
        "text": "Use semantic search only, as natural language is always preferred."
      },
      {
        "letter": "C",
        "text": "Use hybrid search to combine keyword precision with semantic flexibility."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 313,
    "text": "Universal Containers (UC) has registered an external service and created a templatetriggered prompt flow that invokes the external service to fetch data from a REST API. UC now needs to make the response data from the external service usable inside a prompt template as a merge field when the template runs. How should UC meet this requirement?",
    "options": [
      {
        "letter": "A",
        "text": "Use External Service Record merge fields."
      ...
      {
        "letter": "C",
        "text": "Use the 'Add Prompt Instructions' flow element."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 314,
    "text": "Universal Containers aims to streamline the sales team's daily tasks by using AI. When considering these new workflows, which improvement requires the use of Prompt Builder?",
    "options": [
      {
        "letter": "A",
        "text": "Populate an Al-generated time-to close estimation to opportunities"
      },
      {
        "letter": "B",
        "text": "Populate an AI generated summary field for sales contracts."
      },
      {
        "letter": "C",
        "text": "Populate an Al generated lead score for new leads."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 315,
    "text": "Universal Containers Is Interested In Improving the sales operation efficiency by analyzing their data using Al-powered predictions in Einstein Studio. Which use case works for this scenario?",
    "options": [
      {
        "letter": "A",
        "text": "Predict customer sentiment toward a promotion message."
      },
      {
        "letter": "B",
        "text": "Predict customer lifetime value of an account."
      },
      {
        "letter": "C",
        "text": "Predict most popular products from new product catalog."
      }
    ],
    "answer": [
      "B"
    ...
    "multi": false,
    "explanation": "For improving sales operations efficiency, Einstein Studio is ideal for creating AIpowered models that can predict outcomes based on data. One of the most valuable use cases is predicting customer lifetime value, which helps sales teams focus on high-value accounts and make more informed decisions. Customer lifetime value (CLV) predictions can optimize strategies around customer retention, crossselling, and long-term engagement. Option B is the correct choice as predicting customer lifetime value is a well-established use case for AI in sales. Option A (customer sentiment) is typically handled through NLP models, while Option C (product popularity) is more of a marketing analysis use case.",
    "section": "agents"
  },
  {
    "id": 316,
    ...
    "options": [
      {
        "letter": "A",
        "text": "The prompt template version is incompatible with the chosen LLM."
      },
      {
        "letter": "B",
        "text": "The data being used for grounding is incorrect or incomplete."
      },
      {
        "letter": "C",
        "text": "The Einstein Trust Layer is incorrectly configured."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 317,
    "text": "Which business requirement presents a good use case for leveraging Einstein Prompt Builder?",
    "options": [
      {
        "letter": "A",
        "text": "Forecast future sales trends based on historical data."
      },
      {
        "letter": "B",
        "text": "Identify potential high-value leads for targeted marketing campaigns."
      },
      {
        "letter": "C",
        "text": "Send reply to a request for proposal via a personalized email."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 318,
    "text": "A customer service representative is looking at a custom object that stores travel information. They recently received a weather alert and now need to cancel flights for the customers that are related to this Itinerary. The representative needs to review the Knowledge articles about canceling and rebooking the customer flights. Which Agentforce capability helps the representative accomplish this?",
    "options": [
      {
        "letter": "A",
        "text": "Invoke a flow which makes a call to external data to create a Knowledge article."
      ...
      {
        "letter": "C",
        "text": "Generate Knowledge article based off the prompts that the agent enters to create steps to cancel flights."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 319,
    "text": "Universal Containers (UC) plans to implement prompt templates that utilize the standard foundation models. What should UC consider when building prompt templates in Prompt Builder?",
    "options": [
      {
        "letter": "A",
        "text": "Include multiple-choice questions within the prompt to test the LLM's understanding of the context."
      },
      {
        "letter": "B",
        "text": "Ask it to role-play as a character in the prompt template to provide more context to the LLM."
      },
      {
        "letter": "C",
        "text": "Train LLM with data using different writing styles including word choice, intensifiers, emojis, and punctuation."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 320,
    "text": "Universal Containers has developed an agent for loan origination workflows that must handle both non- determinism and strict regulatory compliance requirements. The agent needs to ensure that identity verification and credit check steps execute in a precise sequence without deviation. Which statement correctly differentiates these two instruction patterns in Agent Script's hybrid reasoning approach?",
    "options": [
      {
        "letter": "A",
        "text": "Declarative instructions require Flow execution for business logic, while procedural instructions are native to Agent Script but cannot access external systems or APIs."
      },
      {
        "letter": "B",
        "text": "Declarative instructions provide conversational flexibility through large language model interpretation, while procedural instructions use the - > prefix to enforce guaranteed execution order with run, if, and transitions."
      },
      {
        "letter": "C",
        "text": "Declarative instructions only work in Canvas View for visual editing, while procedural instructions require Script View and cannot be represented in the visual interface."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 321,
    "text": "An Agentforce is tasked to optimize a business process flow by assigning actions to agents within the Salesforce Agentforce Platform. What is the correct method for the Agentforce Specialist to assign actions to an Agent?",
    "options": [
      {
        "letter": "A",
        "text": "Assign the action to a Topic First in Agent Builder."
      },
      {
        "letter": "B",
        "text": "Assign the action to a Topic first on the Agent Actions detail page."
      },
      {
        "letter": "C",
        "text": "Assign the action to a Topic first on Action Builder."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 322,
    "text": "A data science team has trained an XGBoost classification model for product recommendations on Databricks. The Agentforce Specialist is tasked with bringing inferences for product recommendations from this model into Data Cloud as a stand-alone data model object (DMO). How should the Agentforce Specialist set this up?",
    "options": [
      {
        "letter": "A",
        "text": "Create the serving endpoint in Databricks, then configure the model using Model Builder."
      },
      {
        "letter": "B",
        "text": "Create the serving endpoint in Einstein Studio, then configure the model using Model Builder."
      },
      {
        "letter": "C",
        "text": "Create the serving endpoint in Databricks, then configure the model using a Python SDK connector."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 323,
    "text": "Universal Containers wants to allow its service agents to query the current fulfillment status of an order with natural language. There is an existing auto launched flow to query the information from Oracle ERP, which is the system of record for the order fulfillment process. How should An Agentforce apply the power of conversational AI to this use case?",
    "options": [
      {
        "letter": "A",
        "text": "Create a Flex prompt template in Prompt Builder."
      },
      {
        "letter": "B",
        "text": "Create a custom copilot action which calls a flow."
      },
      {
        "letter": "C",
        "text": "Configure the Integration Flow Standard Action in Agent."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 324,
    "text": "An Agentforce Specialist wants to ensure their custom agent action performs as expected in conversations. What should the Agentforce Specialist focus on when creating action instructions?",
    "options": [
      {
        "letter": "A",
        "text": "Write concise agent action instructions and test in Agentforce Builder."
      },
      {
        "letter": "B",
        "text": "Ensure the agent action label matches the utterance's intent."
      },
      {
        "letter": "C",
        "text": "Include comprehensive detailed descriptions and perform smoke testing."
      }
    ],
    "answer": [
      "A"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "C",
        "text": "A sales agent discovering other agents' capabilities using Agent Cards"
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 328,
    "text": "An AgentForce Specialist wants to troubleshoot an agent that is hallucinating weblinks. The agent has an action that uses a prompt template, which is using a knowledge retriever, to generate the output text that the agent will use. Which process is appropriate to find the root cause of the hallucination behavior?",
    "options": [
      {
        "letter": "A",
        "text": "Examine the topic name and classification description for hallucination guardrails."
      },
      {
        "letter": "B",
  ...
  {
    "id": 329,
    "text": "A sales rep at Universal Containers is extremely busy and sometimes will have very long sales calls on voice and video calls and might miss key details. They are just starting to adopt new generative AI features. Which Einstein Generative AI feature should An Agentforce recommend to help the rep get the details they might have missed during a conversation?",
    "options": [
      {
        "letter": "A",
        "text": "Call Summary"
  ...
  {
    "id": 330,
    "text": "Universal Containers implements three custom actions to get three distinct types of sales summaries for its users. Users are complaining that they are not getting the right summary based on their utterances. What should the Agentforce Specialist investigate as the root cause?",
    "options": [
      {
        "letter": "A",
        "text": "Review that the custom action Is assigned to an Agent."
      },
      {
        "letter": "B",
        "text": "Review the action Instructions to ensure they are unique."
      },
      {
        "letter": "C",
        "text": "Ensure the input and output types are correctly chosen."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 331,
    "text": "Universal Containers is planning a marketing email about products that most closely match a customer's expressed interests. What should An Agentforce recommend to generate this email?",
    "options": [
      {
        "letter": "A",
        "text": "Standard email marketing template using Apex or flows for matching interest in products"
      },
      {
        "letter": "B",
        "text": "Custom sales email template which is grounded with interest and product information"
      },
      {
        "letter": "C",
        "text": "Standard email draft with Einstein and choose standard email template"
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 332,
    "text": "An Agentforce Specialist created a Field Generation prompt template. What should the Agentforce Specialist do to expose the template to the user?",
    "options": [
      {
        "letter": "A",
        "text": "Use a screen flow to associate the Field Generation prompt template."
      },
      {
        "letter": "B",
        "text": "Associate the template with the form field on the Lightning page."
      },
      {
        "letter": "C",
        "text": "Call a template using an autolaunched flow."
      }
    ],
    "answer": [
      "B"
  ...
  },
  {
    ...
    "multi": false,
    "explanation": "The correct answer is C because this requirement must be enforced deterministically at the action- availability layer, not trusted to natural language instructions. In Agentforce, filters can control access to subagents and actions so the agent can use them only when defined conditions are met. For refund processing, the \"Issue Refund\" action should be hidden from the reasoning engine unless the account tier condition evaluates to Platinum. Option A is weak because system instructions are interpreted by the model and can be ignored or misapplied. Option B is wrong because blocking a keyword is brittle and does not validate entitlement. Action filters are the correct control because they prevent the action from being available until the business rule is satisfied.",
    "section": "agents"
  },
  {
    "id": 336,
    "text": "What happens when a chunk of text is vectorized?",
    "options": [
      {
        "letter": "A",
        "text": "It creates numerical representations of chunk content to enable meaningbased retrieval."
      },
      {
        "letter": "B",
        "text": "It encrypts the content so it can be stored securely within Data 360 data spaces."
      },
      {
        "letter": "C",
        "text": "It reduces the file size of the original document to reduce Data 360 costs."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 337,
    "text": "Universal Containers ' sales team engages in numerous video sales calls with prospects across the nation. Sales management wants an easy way to understand key information such as deal terms or customer sentiments. Which Einstein Generative AI feature should An Agentforce recommend for this request?",
    "options": [
      {
        "letter": "A",
        "text": "Einstein Call Summaries"
      },
      {
        "letter": "B",
        "text": "Einstein Conversation Insights"
      },
      {
        "letter": "C",
        "text": "Einstein Video KPI"
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 338,
    "text": "A company needs to ensure customers always receive answers based on the most current version of support documentation. What should an Agentforce Specialist recommend?",
    "options": [
      {
        "letter": "A",
        "text": "Use a file-based Agentforce Data Library (ADL) and enable the version management setting to ensure the agent always retrieves the latest document."
      },
      {
        "letter": "B",
        "text": "Use a knowledge-based Agentforce Data Library (ADL); knowledge articles have native versioning built in, so agents automatically retrieve the current published version."
      },
      {
        "letter": "C",
        "text": "Use either Agentforce Data Library (ADL) type; both automatically serve the most recent content once the search index rebuilds."
      }
    ],
    "answer": [
      "B"
  ...
  },
  {
    ...
    "multi": false,
    "explanation": "When a prompt template version is immutable, it means that once the version is activated, it cannot be edited or modified. This ensures consistency in production environments where changes could disrupt workflows.",
    "section": "agents"
  },
  {
    "id": 340,
    ...
    "options": [
      {
        "letter": "A",
        "text": "A tool for developers to use in Visual Studio Code that creates prompts for Apex programming, assisting developers in writing code more efficiently."
      },
      {
        "letter": "B",
        "text": "A tool that enables companies to create reusable prompts for large language models (LLMs), bringing generative AI responses to their flow of work"
      },
      {
        "letter": "C",
        "text": "A tool within Salesforce offering real-time Al-powered suggestions and guidance to users, Improving productivity and decision-making."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 342,
    "text": "Universal Containers (UC) is discussing its AI strategy in an agile Scrum meeting. Which business requirement would lead An Agentforce to recommend connecting to an external foundational model via Einstein Studio (Model Builder)?",
    "options": [
      {
        "letter": "A",
        "text": "UC wants to fine-tune model temperature."
      },
      {
        "letter": "B",
        "text": "UC wants a model fine-tuned using company data."
      },
      {
        "letter": "C",
        "text": "UC wants to change the frequency penalty of the model."
      }
    ],
    "answer": [
      "B"
  ...
  {
    "id": 343,
    "text": "An insurance company needs a Service Agent to ground its responses based on company- specific PDFs and a comprehensive knowledge base. Which type of retriever should the Agentforce Specialist use to meet this requirement?",
    "options": [
      {
        "letter": "A",
  ...
  {
    "id": 346,
    "text": "A company wants to retrieve patient history details to augment the AI agent response and plans to use the Data Cloud search index feature. What is best practice when considering retrievalaugmented generation (RAG) for information that may contain personally identifiable information (PII)?",
    "options": [
      {
        "letter": "A",
        "text": "Mask sensitive fields and index only nonPII data"
      },
      {
        "letter": "B",
        "text": "Depend on the agent's prompt to avoid exposing PII"
  ...
  {
    "id": 349,
    "text": "Universal Containers (UC) is preparing and defining success criteria for Agentforce Testing Center test cases. Which details should UC specify as the expected output to ensure the tests accurately reflect the agent's functionality?",
    "options": [
      {
        "letter": "A",
        "text": "Expected Topic API Name"
      },
      {
        "letter": "B",
        "text": "Expected Flow API Name"
      },
      {
        "letter": "C",
        "text": "Expected Prompt Template Name"
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 350,
    "text": "Universal Containers (UC) recently attended a major trade show and received thousands of new leads from event badge scans. UC is struggling to follow up with each lead in a timely, personalized way. Leadership wants to: Qualify and nurture leads 24/7. * Provide accurate answers to prospect questions. * Automatically book meetings with qualified prospects. * Free up reps to focus on building relationships and closing deals. Which Agentforce capability should UC implement to meet these goals?",
    "options": [
      {
        "letter": "A",
        "text": "SDR Agent"
  ...
  },
  {
    ...
    "options": [
      {
        "letter": "A",
        "text": "Storing this data requires Data Cloud to be provisioned."
      },
      {
        "letter": "B",
        "text": "Storing this data requires a custom object for data to be configured."
      },
      {
        "letter": "C",
        "text": "Storing this data requires Salesforce big objects."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 354,
    "text": "Universal Containers has a strict change management process that requires all possible configuration to be completed in a sandbox which will be deployed to production. The Agentforce Specialist is tasked with setting up Work Summaries for Enhanced Messaging. Einstein Generative AI is already enabled in production, and the Einstein Work Summaries permission set is already available in production. Which other configuration steps should the Agentforce Specialist take in the sandbox that can be deployed to the production org?",
    "options": [
      {
        "letter": "A",
        "text": "create custom fields to store Issue, Resolution, and Summary; create a Quick Action that updates these fields: add the Wrap Up component to the Messaging Session record paae layout: and create Permission Set Assignments for the intended Agents."
      },
      {
        "letter": "B",
        "text": "From the Epstein setup menu, select Turn on Einstein: create custom fields to store Issue, Resolution, and Summary: create a Quick Action that updates these fields: and add the wrap up componert to the Messaging session record page layout."
      },
      {
        "letter": "C",
        "text": "Create custom fields to store issue, Resolution, and Summary; create a Quick Action that updates these fields: and ado the Wrap up component to the Messaging session record page lavcut."
      }
    ],
    "answer": [
      "C"
  ...
  },
  {
    ...
    "multi": false,
    "explanation": "The correct answer is C. In a multilingual RAG design, the embedding model must support semantic similarity across the languages involved in both the source content and user queries. Since the articles are in Spanish and users may ask questions in French or English, selecting the multilingual-e5- large embedding model broadly for the search index is the correct approach. Option A and Option B are too narrow because each excludes one of the languages in the complete requirement. The retriever does not simply match keywords; it compares vector representations of the query and indexed chunks. A multilingual embedding model improves crosslanguage retrieval by placing semantically similar text from different languages closer in vector space. Salesforce Data 360 search index guidance identifies multilingual content and embedding-model selection as key retrieval considerations.",
    "section": "data"
  },
  {
    "id": 357,
    "text": "Universal Containers is designing an agent to assist with order management and dealer support automation. The agent must verify a dealer's credentials before granting access to order details. The team has already: Declared a variable is_verified to track verification status. Configured an action that verifies the dealer's credentials. They plan to restrict access to the order details subagent using a guard condition based on is_verified. What must the team do to ensure the order details subagent becomes available only after a dealer is successfully verified?",
    "options": [
      {
        "letter": "A",
        "text": "Add an available when: @variables.is_verified == true condition to the order details subagent."
      },
      {
        "letter": "B",
        "text": "Declare the is_verified variable as immutable so it cannot be modified during the session."
      },
      {
        "letter": "C",
        "text": "Update the is_verified variable to true after the verification action succeeds using @utils.setVariables."
      }
    ],
    "answer": [
      "C"
  ...
  {
    "id": 358,
    "text": "Universal Containers (UC) wants to improve the productivity of its sales team with generative AI technology. However, UC is concerned that public AI virtual assistants lack adequate company data to general useful responses. Which solution should UC consider?",
    "options": [
      {
        "letter": "A",
        "text": "fine-tune the Einstein AI model with CBM data."
      },
      {
        "letter": "B",
        "text": "Build Al model with Einstein discovery and deploy to sales users."
      },
      {
        "letter": "C",
        "text": "Enable Agentforce and deploy to sales users."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 360,
    "text": "Universal Containers (UC) uses Salesforce Service Cloud to support its customers and agents handling cases. UC is considering implementing Agent and extending Service Cloud to mobile users. When would Agent implementation be most advantageous?",
    "options": [
      {
        "letter": "A",
        "text": "When the goal is to streamline customer support processes and improve response times"
      },
      {
        "letter": "B",
        "text": "When the main objective is to enhance data security and compliance measures"
      },
      {
        "letter": "C",
        "text": "When the focus is on optimizing marketing campaigns and strategies"
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 361,
    "text": "Which scenario best demonstrates when an Agentforce Data Library is most useful for improving an AI agent' s response accuracy?",
    "options": [
      {
        "letter": "A",
        "text": "When the AI agent must provide answers based on a curated set of policy documents that are stored, regularly updated, and indexed in the data library."
      },
      {
        "letter": "B",
        "text": "When the AI agent needs to combine data from disparate sources based on mutually common data, such as Customer Id and Product Id for grounding."
      },
      {
        "letter": "C",
        "text": "When data is being retrieved from Snowflake using zero-copy for vectorization and retrieval."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 362,
    "text": "The marketing team at Universal Containers is looking for a way personalize emails based on customer behavior, preferences, and purchase history. Why should the team use Agent as the solution?",
    "options": [
      {
        "letter": "A",
        "text": "To generate relevant content when engaging with each customer"
      },
      {
        "letter": "B",
        "text": "To analyze past campaign performance"
      },
      {
        "letter": "C",
        "text": "To send automated emails to all customers"
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 363,
    "text": "Universal Containers' Agentforce Service Agent has been live for four weeks. Agent Optimization in Agentforce Observability shows the main support intent cluster scoring low quality, with score reasons citing ambiguous subagent match. The Session Trace confirms the reasoning engine is consistently selecting the wrong subagent on most turns. What is the most viable solution to resolve the issue?",
    "options": [
      {
        "letter": "A",
        "text": "Refine the classification descriptions and scope of the competing subagents to eliminate the semantic overlap that is causing the reasoning engine to misroute."
      },
      {
        "letter": "B",
        "text": "Use the intent cluster data from Agent Optimization to identify the most frequently misrouted intents and add new subagents with tightly scoped classification descriptions for each."
      },
      {
        "letter": "C",
        "text": "Extend the agent's data library with additional knowledge articles covering the misrouted intent scenarios identified in Agent Optimization."
      }
    ],
    "answer": [
      "A"
  ...
  {
    "id": 364,
    "text": "Universal Containers is configuring its Agentforce Testing Center to evaluate an agent handling customer complaints. The company wants to assess if the agent successfully demonstrates empathy and follows a proprietary \"De-escalation Framework\" before offering a resolution. Where should the Agentforce Specialist utilize a large language model (LLM)-as-judge to achieve an appropriate evaluation?",
    "options": [
      {
        "letter": "A",
        "text": "Adjust the fixed criteria of the standard Coherence quality evaluation to control the LLM-as-judge evaluation."
      },
      {
        "letter": "B",
        "text": "Enable the default Instruction Adherence evaluation which natively uses LLMas-judge."
      },
      {
        "letter": "C",
        "text": "Create a custom evaluation with a tailored prompt outlining the framework's criteria."
      }
    ],
    "answer": [
      "C"
